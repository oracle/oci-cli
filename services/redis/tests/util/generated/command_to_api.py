...
SDK_client_map = {
    "redis.cancel_work_request": "oci.redis.RedisClusterClient.cancel_work_request",
    "redis.change_redis_cluster_compartment": "oci.redis.RedisClusterClient.change_redis_cluster_compartment",
    "redis.create_redis_cluster": "oci.redis.RedisClusterClient.create_redis_cluster",
    ...
    "redis.list_work_requests": "oci.redis.RedisClusterClient.list_work_requests",
    "redis.update_redis_cluster": "oci.redis.RedisClusterClient.update_redis_cluster",
}
