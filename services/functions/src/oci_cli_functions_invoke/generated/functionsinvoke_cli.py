...
@click.command(cli_util.override('functions_invoke_root_group.command_name', 'functions-invoke'), cls=CommandGroupWithAlias, help=cli_util.override('functions_invoke_root_group.help', """API for the Functions service.
"""), short_help=cli_util.override('functions_invoke_root_group.short_help', """Functions Service API"""))
...
@function_group.command(name=cli_util.override('invoke_function.command_name', 'invoke'), help=u"""Invokes a function""")
