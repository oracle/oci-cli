...
@click.command(cli_util.override('functions_invoke.functions_invoke_root_group.command_name', 'functions-invoke'), cls=CommandGroupWithAlias, help=cli_util.override('functions_invoke.functions_invoke_root_group.help', """API for the Functions service.
"""), short_help=cli_util.override('functions_invoke.functions_invoke_root_group.short_help', """Functions Service API"""))
