...
@click.command(cli_util.override('perfhub.perfhub_root_group.command_name', 'perfhub'), cls=CommandGroupWithAlias, help=cli_util.override('perfhub.perfhub_root_group.help', """Use the Database Management API to perform tasks such as obtaining performance and resource usage metrics
for a fleet of Managed Databases or a specific Managed Database, creating Managed Database Groups, and
running a SQL job on a Managed Database or Managed Database Group."""), short_help=cli_util.override('perfhub.perfhub_root_group.short_help', """Database Management API"""))
