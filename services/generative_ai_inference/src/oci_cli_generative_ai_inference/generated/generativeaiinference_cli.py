...
This option is a JSON list with items of type CohereToolV2.  For documentation on CohereToolV2 please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/generativeaiinference/20231130/datatypes/CohereToolV2.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type Message.  For documentation on Message please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/generativeaiinference/20231130/datatypes/Message.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type ToolDefinition.  For documentation on ToolDefinition please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/generativeaiinference/20231130/datatypes/ToolDefinition.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
@cli_util.option('--chat-request-service-tier', type=custom_types.CliCaseInsensitiveChoice(["AUTO", "DEFAULT", "PRIORITY"]), help=u"""Specifies the processing type used for serving the request.""")
...
def chat_generic_chat_request(ctx, from_json, compartment_id, serving_mode, chat_request_messages, chat_request_reasoning_effort, chat_request_verbosity, chat_request_metadata, chat_request_is_stream, chat_request_stream_options, chat_request_num_generations, chat_request_seed, chat_request_is_echo, chat_request_top_k, chat_request_top_p, chat_request_temperature, chat_request_frequency_penalty, chat_request_presence_penalty, chat_request_stop, chat_request_log_probs, chat_request_max_tokens, chat_request_max_completion_tokens, chat_request_logit_bias, chat_request_prediction, chat_request_response_format, chat_request_tool_choice, chat_request_is_parallel_tool_calls, chat_request_tools, chat_request_web_search_options, chat_request_service_tier):
    ...
    if chat_request_service_tier is not None:
        _details['chatRequest']['serviceTier'] = chat_request_service_tier
...
This option is a JSON list with items of type CohereMessage.  For documentation on CohereMessage please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/generativeaiinference/20231130/datatypes/CohereMessage.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type CohereTool.  For documentation on CohereTool please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/generativeaiinference/20231130/datatypes/CohereTool.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type CohereToolResult.  For documentation on CohereToolResult please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/generativeaiinference/20231130/datatypes/CohereToolResult.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
