...
def get_runbook_import(ctx, from_json, runbook_id, import_id):
    ...
    if isinstance(import_id, str) and len(import_id.strip()) == 0:
...
This option is a JSON list with items of type Task.  For documentation on Task please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/fleetappsmanagementrunbooks/20250228/datatypes/Task.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--groups', type=custom_types.CLI_COMPLEX_TYPE, help=u"""The groups of the runbook version.

This option is a JSON list with items of type Group.  For documentation on Group please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/fleetappsmanagementrunbooks/20250228/datatypes/Group.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
