...
@click.command(cli_util.override('fleet_apps_management.work_request_log_entry_group.command_name', 'work-request-log-entry'), cls=CommandGroupWithAlias, help="""A log message from the execution of a work request.""")
@cli_util.help_option_group
...
@click.command(cli_util.override('fleet_apps_management.work_request_group.command_name', 'work-request'), cls=CommandGroupWithAlias, help="""A description of workrequest status""")
@cli_util.help_option_group
...
@click.command(cli_util.override('fleet_apps_management.work_request_error_group.command_name', 'work-request-error'), cls=CommandGroupWithAlias, help="""An error encountered while executing a work request.""")
@cli_util.help_option_group
...
fleet_apps_management_root_group.add_command(work_request_log_entry_group)
fleet_apps_management_root_group.add_command(fleet_resource_collection_group)
fleet_apps_management_root_group.add_command(work_request_group)
...
fleet_apps_management_root_group.add_command(work_request_error_group)
...
fleet_apps_management_service_cli.fleet_apps_management_service_group.add_command(work_request_log_entry_group)
fleet_apps_management_service_cli.fleet_apps_management_service_group.add_command(fleet_resource_collection_group)
fleet_apps_management_service_cli.fleet_apps_management_service_group.add_command(work_request_group)
...
fleet_apps_management_service_cli.fleet_apps_management_service_group.add_command(work_request_error_group)
...
def create_fleet(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, fleet_type, display_name, description, products, application_type, environment_type, group_type, resource_selection_type, rule_selection_criteria, notification_preferences, resources, credentials, is_target_auto_confirm, freeform_tags, defined_tags):
    ...
    if resource_selection_type is not None:
        _details['resourceSelectionType'] = resource_selection_type

    if rule_selection_criteria is not None:
        _details['ruleSelectionCriteria'] = cli_util.parse_json_parameter("rule_selection_criteria", rule_selection_criteria)
...
@cli_util.wrap_exceptions
def create_fleet_credential(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, display_name, compartment_id, entity_specifics, user, password, fleet_id):
...
@cli_util.wrap_exceptions
def create_fleet_property(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, value, property_id, fleet_id):
...
@work_request_group.command(name=cli_util.override('fleet_apps_management.get_work_request.command_name', 'get'), help=u"""Gets details of the work request with the given ID. \n[Command Reference](getWorkRequest)""")
@cli_util.option('--work-request-id', required=True, help=u"""The ID of the asynchronous request.""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'fleet_apps_management', 'class': 'WorkRequest'})
@cli_util.wrap_exceptions
...
@cli_util.wrap_exceptions
def list_announcements(ctx, from_json, all_pages, page_size, summary_contains, display_name, limit, page, sort_order, sort_by):
...
@cli_util.wrap_exceptions
def list_fleet_properties(ctx, from_json, all_pages, page_size, fleet_id, compartment_id, lifecycle_state, display_name, id, limit, page, sort_order, sort_by):
...
@cli_util.wrap_exceptions
def list_fleet_resources(ctx, from_json, all_pages, page_size, fleet_id, tenancy_id, lifecycle_state, display_name, id, fleet_resource_type, limit, page, sort_order, sort_by):
...
@work_request_error_group.command(name=cli_util.override('fleet_apps_management.list_work_request_errors.command_name', 'list'), help=u"""Returns a (paginated) list of errors for the work request with the given ID. \n[Command Reference](listWorkRequestErrors)""")
@cli_util.option('--work-request-id', required=True, help=u"""The ID of the asynchronous request.""")
@cli_util.option('--page', help=u"""A token representing the position at which to start retrieving results. This must come from the `opc-next-page` header field of a previous response.""")
@cli_util.option('--limit', type=click.INT, help=u"""The maximum number of items to return.""")
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'fleet_apps_management', 'class': 'WorkRequestErrorCollection'})
@cli_util.wrap_exceptions
...
@work_request_log_entry_group.command(name=cli_util.override('fleet_apps_management.list_work_request_logs.command_name', 'list-work-request-logs'), help=u"""Returns a (paginated) list of logs for the work request with the given ID. \n[Command Reference](listWorkRequestLogs)""")
@cli_util.option('--work-request-id', required=True, help=u"""The ID of the asynchronous request.""")
@cli_util.option('--page', help=u"""A token representing the position at which to start retrieving results. This must come from the `opc-next-page` header field of a previous response.""")
@cli_util.option('--limit', type=click.INT, help=u"""The maximum number of items to return.""")
@cli_util.option('--sort-by', type=custom_types.CliCaseInsensitiveChoice(["timestamp"]), help=u"""The field to sort by. Only one sort order may be provided. Default order for timestamp is descending.""")
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'fleet_apps_management', 'class': 'WorkRequestLogEntryCollection'})
@cli_util.wrap_exceptions
...
@work_request_group.command(name=cli_util.override('fleet_apps_management.list_work_requests.command_name', 'list'), help=u"""Lists the work requests in a compartment. \n[Command Reference](listWorkRequests)""")
@cli_util.option('--compartment-id', help=u"""The ID of the compartment in which to list resources.""")
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'fleet_apps_management', 'class': 'WorkRequestSummaryCollection'})
@cli_util.wrap_exceptions
...
@cli_util.wrap_exceptions
def update_fleet(ctx, from_json, force, wait_for_state, max_wait_seconds, wait_interval_seconds, fleet_id, display_name, description, notification_preferences, rule_selection_criteria, is_target_auto_confirm, freeform_tags, defined_tags, if_match):

    if isinstance(fleet_id, six.string_types) and len(fleet_id.strip()) == 0:
        raise click.UsageError('Parameter --fleet-id cannot be whitespace or empty string')
    if not force:
        if notification_preferences or rule_selection_criteria or freeform_tags or defined_tags:
            if not click.confirm("WARNING: Updates to notification-preferences and rule-selection-criteria and freeform-tags and defined-tags will replace any existing values. Are you sure you want to continue?"):
                ctx.abort()
