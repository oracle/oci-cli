...
This option is a JSON list with items of type Tag.  For documentation on Tag please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/usageapi/20200107/datatypes/Tag.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
