...
This option is a JSON list with items of type PostInstallationActions.  For documentation on PostInstallationActions please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/javamanagementservice/20210610/datatypes/PostInstallationActions.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
def delete_task_schedule(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, task_schedule_id, fleet_id, if_match):
    ...
    if isinstance(task_schedule_id, str) and len(task_schedule_id.strip()) == 0:
...
def list_library_application_usage(ctx, from_json, all_pages, page_size, fleet_id, library_key, application_id, managed_instance_id, application_name, application_name_contains, time_start, time_end, limit, page, sort_by, sort_order):
    ...
    if isinstance(library_key, str) and len(library_key.strip()) == 0:
...
def list_uncorrelated_package_application_usage(ctx, from_json, all_pages, page_size, fleet_id, package_name, application_id, managed_instance_id, time_start, time_end, limit, page, sort_by, sort_order):
    ...
    if isinstance(package_name, str) and len(package_name.strip()) == 0:
...
This option is a JSON list with items of type JfrAttachmentTarget.  For documentation on JfrAttachmentTarget please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/javamanagementservice/20210610/datatypes/JfrAttachmentTarget.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
@cli_util.wrap_exceptions
def summarize_installation_usage(ctx, from_json, fleet_id, jre_vendor, jre_distribution, jre_version, installation_path, application_id, managed_instance_id, fields, time_start, time_end, limit, page, sort_order, sort_by, os_family, path_contains, jre_security_status):
