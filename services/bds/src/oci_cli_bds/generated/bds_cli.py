...
@cli_util.option('--network-config', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Additional configuration of customer's network.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
