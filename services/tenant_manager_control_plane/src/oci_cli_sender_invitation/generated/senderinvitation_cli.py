...
@click.command(cli_util.override('sender_invitation.sender_invitation_root_group.command_name', 'sender-invitation'), cls=CommandGroupWithAlias, help=cli_util.override('sender_invitation.sender_invitation_root_group.help', """A description of the TenantManager API"""), short_help=cli_util.override('sender_invitation.sender_invitation_root_group.short_help', """TenantManager API"""))
...
@sender_invitation_group.command(name=cli_util.override('sender_invitation.create_sender_invitation.command_name', 'create'), help=u"""Creates a sender invitation and asynchronously sends the invitation to recipient. \n[Command Reference](createSenderInvitation)""")
