...
@cli_util.option('--compute-shape', required=True, help=u"""Type of compute shape - one of Standard, (Enterprise) Small, Medium, Large or Extra Large""")
...
@cli_util.option('--idcs-access-token', help=u"""IDCS access token""")
