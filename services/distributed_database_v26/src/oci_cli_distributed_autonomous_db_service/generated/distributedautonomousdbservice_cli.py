...
distributed_database_v26_service_cli.distributed_database_v26_service_group.add_command(distributed_autonomous_db_service_root_group)
...
def add_distributed_autonomous_database_gds_control_node(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, distributed_autonomous_database_id, public_ssh_key, subnet_id, if_match):
    ...
    client = cli_util.build_client('distributed_database_v26', 'distributed_autonomous_db_service', ctx)
...
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
@json_skeleton_utils.get_cli_json_input_option({'db-backup-config': {'module': 'distributed_database_v26', 'class': 'DistributedAutonomousDbBackupConfig'}})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'db-backup-config': {'module': 'distributed_database_v26', 'class': 'DistributedAutonomousDbBackupConfig'}})
@cli_util.wrap_exceptions
...
def configure_distributed_autonomous_database_auto_resource_management(ctx, from_json, distributed_autonomous_database_id, is_enabled, cool_off_period_in_minutes, max_move_ru_attempts, max_move_ru_unit, mode, action_type, notification_topic_ids, stream_ids, if_match):
    ...
    client = cli_util.build_client('distributed_database_v26', 'distributed_autonomous_db_service', ctx)
    result = client.configure_distributed_autonomous_database_auto_resource_management(
        distributed_autonomous_database_id=distributed_autonomous_database_id,
        configure_distributed_autonomous_database_auto_resource_management_details=_details,
        **kwargs
    )
    cli_util.render_response(result, ctx)
...
@cli_util.option('--db-workload-type', required=True, type=custom_types.CliCaseInsensitiveChoice(["OLTP", "DW"]), help=u"""Possible workload types. Currently only OLTP workload type is supported.""")
...
@cli_util.option('--notification-topic-ids', type=custom_types.CLI_COMPLEX_TYPE, help=u"""The collection of [OCID] for the notification topics associated with the globally distributed autonomous database.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type CreateAutonomousCompositeDataGuardShardSpaceDetails.  For documentation on CreateAutonomousCompositeDataGuardShardSpaceDetails please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/distributedautonomousdbservice/20260101/datatypes/CreateAutonomousCompositeDataGuardShardSpaceDetails.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--system-raft-clusters', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Collection of system raft clusters.

This option is a JSON list with items of type CreateAutonomousSystemRaftClusterDetails.  For documentation on CreateAutonomousSystemRaftClusterDetails please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/distributedautonomousdbservice/20260101/datatypes/CreateAutonomousSystemRaftClusterDetails.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type CreateAutonomousUserShardSpaceDetails.  For documentation on CreateAutonomousUserShardSpaceDetails please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/distributedautonomousdbservice/20260101/datatypes/CreateAutonomousUserShardSpaceDetails.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
@cli_util.option('--vcn-nsg-ids', type=custom_types.CLI_COMPLEX_TYPE, help=u"""The list of network security group (NSG) details to be associated with the distributed autonomous database.

This option is a JSON list with items of type VcnNsgIdsDetails.  For documentation on VcnNsgIdsDetails please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/distributedautonomousdbservice/20260101/datatypes/VcnNsgIdsDetails.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
def create_distributed_autonomous_database(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, display_name, database_version, prefix, private_endpoint_ids, db_workload_type, character_set, ncharacter_set, listener_port, ons_port_local, ons_port_remote, catalog_details, notification_topic_ids, listener_port_tls, system_chunk_count, system_raft_replication_unit_count, composite_raft_shard_spaces, composite_data_guard_shard_spaces, system_raft_clusters, system_data_guard_databases, user_shard_spaces, db_backup_config, vcn_nsg_ids, freeform_tags, defined_tags):
    ...
    _details['dbWorkloadType'] = db_workload_type
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'distributed_database_v26', 'class': 'DistributedAutonomousDatabase'})
@cli_util.wrap_exceptions
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'distributed_database_v26', 'class': 'DistributedAutonomousDatabaseRaftMetric'})
@cli_util.wrap_exceptions
...
@distributed_database_group.command(name=cli_util.override('distributed_autonomous_db_service.get_distributed_autonomous_database_ru_change_log.command_name', 'get-distributed-autonomous-database-ru-change-log'), help=u"""Operation to retrieve move RU invocation history and status for the Globally distributed autonomous database. Results are ordered by created timestamp in descending order. \n[Command Reference](getDistributedAutonomousDatabaseRuChangeLog)""")
@cli_util.option('--distributed-autonomous-database-id', required=True, help=u"""Globally distributed autonomous database identifier.""")
@cli_util.option('--source-shard-name', help=u"""The source shard name to filter RU change log entries.""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'distributed_database_v26', 'class': 'DistributedAutonomousDatabaseRuChangeLog'})
@cli_util.wrap_exceptions
def get_distributed_autonomous_database_ru_change_log(ctx, from_json, distributed_autonomous_database_id, source_shard_name):
    ...
    kwargs['opc_request_id'] = cli_util.use_or_generate_request_id(ctx.obj['request_id'])
    client = cli_util.build_client('distributed_database_v26', 'distributed_autonomous_db_service', ctx)
    result = client.get_distributed_autonomous_database_ru_change_log(
        distributed_autonomous_database_id=distributed_autonomous_database_id,
        **kwargs
    )
    cli_util.render_response(result, ctx)
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'distributed_database_v26', 'class': 'DistributedAutonomousDatabaseCollection'})
@cli_util.wrap_exceptions
def list_distributed_autonomous_databases(ctx, from_json, all_pages, page_size, compartment_id, compartment_id_in_subtree, private_endpoint_id, lifecycle_state, limit, page, sort_order, sort_by, is_auto_resource_management_enabled, display_name, db_deployment_type, metadata):
...
This option is a JSON list with items of type PatchInstruction.  For documentation on PatchInstruction please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/distributedautonomousdbservice/20260101/datatypes/PatchInstruction.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "WAITING", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED", "NEEDS_ATTENTION"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state NEEDS_ATTENTION would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
...
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
@json_skeleton_utils.get_cli_json_input_option({'database-details': {'module': 'distributed_database_v26', 'class': 'list[RotateDistributedAutonomousDatabaseDetails]'}})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'database-details': {'module': 'distributed_database_v26', 'class': 'list[RotateDistributedAutonomousDatabaseDetails]'}})
@cli_util.wrap_exceptions
def rotate_distributed_autonomous_database_passwords(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, distributed_autonomous_database_id, database_details, if_match):
    ...
    result = client.rotate_distributed_autonomous_database_passwords(
        distributed_autonomous_database_id=distributed_autonomous_database_id,
        rotate_distributed_autonomous_database_passwords_details=_details,
        **kwargs
    )
    if wait_for_state:
...
@distributed_autonomous_database_group.command(name=cli_util.override('distributed_autonomous_db_service.scale_distributed_autonomous_database_gsms.command_name', 'scale-distributed-autonomous-database-gsms'), help=u"""Scale global service manager(GSM aka shard director) instances for the Globally distributed autonomous database. \n[Command Reference](scaleDistributedAutonomousDatabaseGsms)""")
@cli_util.option('--distributed-autonomous-database-id', required=True, help=u"""Globally distributed autonomous database identifier.""")
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "WAITING", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED", "NEEDS_ATTENTION"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state NEEDS_ATTENTION would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
...
def scale_distributed_autonomous_database_gsms(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, distributed_autonomous_database_id, if_match):
    ...
    client = cli_util.build_client('distributed_database_v26', 'distributed_autonomous_db_service', ctx)
    result = client.scale_distributed_autonomous_database_gsms(
        distributed_autonomous_database_id=distributed_autonomous_database_id,
        scale_distributed_autonomous_database_gsms_details=_details,
        **kwargs
    )
    if wait_for_state:
...
@distributed_autonomous_database_group.command(name=cli_util.override('distributed_autonomous_db_service.start_distributed_autonomous_database.command_name', 'start'), help=u"""Start the shards, catalog, GSMs and GDSCTL instances of Globally distributed autonomous database. \n[Command Reference](startDistributedAutonomousDatabase)""")
@cli_util.option('--distributed-autonomous-database-id', required=True, help=u"""Globally distributed autonomous database identifier.""")
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "WAITING", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED", "NEEDS_ATTENTION"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state NEEDS_ATTENTION would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
...
@distributed_autonomous_database_group.command(name=cli_util.override('distributed_autonomous_db_service.stop_distributed_autonomous_database.command_name', 'stop'), help=u"""Stop the shards, catalog, GSMs and GDSCTL instances for the Globally distributed autonomous database. \n[Command Reference](stopDistributedAutonomousDatabase)""")
@cli_util.option('--distributed-autonomous-database-id', required=True, help=u"""Globally distributed autonomous database identifier.""")
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "WAITING", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED", "NEEDS_ATTENTION"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state NEEDS_ATTENTION would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
...
@cli_util.option('--notification-topic-ids', type=custom_types.CLI_COMPLEX_TYPE, help=u"""The collection of [OCID] for the notification topics associated with the globally distributed autonomous database. Pass an empty list (`[]`) to remove existing notification topics (set `notificationTopicIds` to empty).""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--freeform-tags', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{\"bar-key\": \"value\"}`""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--defined-tags', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
