...
This option is a JSON list with items of type ResourceFilter.  For documentation on ResourceFilter please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/schedule/20240430/datatypes/ResourceFilter.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type Resource.  For documentation on Resource please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/schedule/20240430/datatypes/Resource.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
