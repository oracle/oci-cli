...
@click.command(cli_util.override('notification_control_plane_root_group.command_name', 'notification-control-plane'), cls=CommandGroupWithAlias, help=cli_util.override('notification_control_plane_root_group.help', """Use the Notification API to broadcast messages to distributed components by topic, using a publish-subscribe pattern.
...
"""), short_help=cli_util.override('notification_control_plane_root_group.short_help', """Notification API"""))
...
@click.command(cli_util.override('topic_group.command_name', 'topic'), cls=CommandGroupWithAlias, help="""""")
@cli_util.help_option_group
def topic_group():
    pass
