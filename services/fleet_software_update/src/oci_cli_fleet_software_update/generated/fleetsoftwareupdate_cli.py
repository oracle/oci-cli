...
@click.command(cli_util.override('fleet_software_update.fsu_readiness_check_group.command_name', 'fsu-readiness-check'), cls=CommandGroupWithAlias, help="""Exadata Fleet Update Readiness Check resource details.""")
@cli_util.help_option_group
def fsu_readiness_check_group():
    pass
...
@click.command(cli_util.override('fleet_software_update.fsu_readiness_check_summary_group.command_name', 'fsu-readiness-check-summary'), cls=CommandGroupWithAlias, help="""Exadata Fleet Update Readiness Check Resource.""")
@cli_util.help_option_group
def fsu_readiness_check_summary_group():
    pass
...
fleet_software_update_root_group.add_command(fsu_readiness_check_group)
...
fleet_software_update_root_group.add_command(fsu_readiness_check_summary_group)
...
@fsu_readiness_check_group.command(name=cli_util.override('fleet_software_update.change_fsu_readiness_check_compartment.command_name', 'change-compartment'), help=u"""Moves a Exadata Fleet Update Readiness Check resource from one compartment identifier to another. When provided, If-Match is checked against ETag values of the resource. \n[Command Reference](changeFsuReadinessCheckCompartment)""")
@cli_util.option('--fsu-readiness-check-id', required=True, help=u"""Unique Exadata Fleet Update Readiness Check identifier.""")
@cli_util.option('--compartment-id', required=True, help=u"""The [OCID] of the compartment into which the resource should be moved.""")
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
...
def change_fsu_readiness_check_compartment(ctx, from_json, fsu_readiness_check_id, compartment_id, if_match):
    ...
    client = cli_util.build_client('fleet_software_update', 'fleet_software_update', ctx)
    result = client.change_fsu_readiness_check_compartment(
        fsu_readiness_check_id=fsu_readiness_check_id,
        change_fsu_readiness_check_compartment_details=_details,
        **kwargs
    )
    cli_util.render_response(result, ctx)
...
@cli_util.option('--service-type', required=True, type=custom_types.CliCaseInsensitiveChoice(["EXACS", "EXACC", "EXADBXS"]), help=u"""Exadata service type for the target resource members.""")
...
@cli_util.option('--compartment-id', required=True, help=u"""Compartment Identifier.""")
@cli_util.option('--details-service-type', required=True, type=custom_types.CliCaseInsensitiveChoice(["EXACS", "EXACC", "EXADBXS"]), help=u"""Exadata service type for the target resource members.""")
...
@fsu_readiness_check_group.command(name=cli_util.override('fleet_software_update.create_fsu_readiness_check.command_name', 'create'), help=u"""Creates a new Exadata Fleet Update Readiness Check. \n[Command Reference](createFsuReadinessCheck)""")
@cli_util.option('--compartment-id', required=True, help=u"""The [OCID] of the Compartment.""")
@cli_util.option('--type', required=True, help=u"""Type of Exadata Fleet Update Readiness Check.""")
@cli_util.option('--display-name', help=u"""The user-friendly name for the Exadata Fleet Update Readiness Check resource.""")
@cli_util.option('--freeform-tags', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{\"bar-key\": \"value\"}`""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--defined-tags', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "WAITING", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED", "NEEDS_ATTENTION"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state NEEDS_ATTENTION would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'freeform-tags': {'module': 'fleet_software_update', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'fleet_software_update', 'class': 'dict(str, dict(str, object))'}}, output_type={'module': 'fleet_software_update', 'class': 'FsuReadinessCheck'})
@cli_util.wrap_exceptions
def create_fsu_readiness_check(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, type, display_name, freeform_tags, defined_tags):
    ...
    client = cli_util.build_client('fleet_software_update', 'fleet_software_update', ctx)
    result = client.create_fsu_readiness_check(
        create_fsu_readiness_check_details=_details,
        **kwargs
    )
    if wait_for_state:
...
@fsu_readiness_check_group.command(name=cli_util.override('fleet_software_update.create_fsu_readiness_check_create_target_fsu_readiness_check_details.command_name', 'create-fsu-readiness-check-create-target-fsu-readiness-check-details'), help=u"""Creates a new Exadata Fleet Update Readiness Check. \n[Command Reference](createFsuReadinessCheck)""")
@cli_util.option('--compartment-id', required=True, help=u"""The [OCID] of the Compartment.""")
@cli_util.option('--display-name', help=u"""The user-friendly name for the Exadata Fleet Update Readiness Check resource.""")
@cli_util.option('--freeform-tags', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{\"bar-key\": \"value\"}`""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--defined-tags', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--targets', type=custom_types.CLI_COMPLEX_TYPE, help=u"""List of targets that will run the Exadata Fleet Update Readiness Check. The targets have to be of the same entity type.

This option is a JSON list with items of type ReadinessCheckTargetEntry.  For documentation on ReadinessCheckTargetEntry please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/fleetsoftwareupdate/20220528/datatypes/ReadinessCheckTargetEntry.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "WAITING", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED", "NEEDS_ATTENTION"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state NEEDS_ATTENTION would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
@json_skeleton_utils.get_cli_json_input_option({'freeform-tags': {'module': 'fleet_software_update', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'fleet_software_update', 'class': 'dict(str, dict(str, object))'}, 'targets': {'module': 'fleet_software_update', 'class': 'list[ReadinessCheckTargetEntry]'}})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'freeform-tags': {'module': 'fleet_software_update', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'fleet_software_update', 'class': 'dict(str, dict(str, object))'}, 'targets': {'module': 'fleet_software_update', 'class': 'list[ReadinessCheckTargetEntry]'}}, output_type={'module': 'fleet_software_update', 'class': 'FsuReadinessCheck'})
@cli_util.wrap_exceptions
def create_fsu_readiness_check_create_target_fsu_readiness_check_details(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, display_name, freeform_tags, defined_tags, targets):
...
@fsu_readiness_check_group.command(name=cli_util.override('fleet_software_update.delete_fsu_readiness_check.command_name', 'delete'), help=u"""Deletes a Exadata Fleet Update Readiness Check resource by identifier. \n[Command Reference](deleteFsuReadinessCheck)""")
@cli_util.option('--fsu-readiness-check-id', required=True, help=u"""Unique Exadata Fleet Update Readiness Check identifier.""")
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.confirm_delete_option
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "WAITING", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED", "NEEDS_ATTENTION"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state NEEDS_ATTENTION would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
...
def delete_fsu_readiness_check(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, fsu_readiness_check_id, if_match):
    ...
    kwargs['opc_request_id'] = cli_util.use_or_generate_request_id(ctx.obj['request_id'])
    client = cli_util.build_client('fleet_software_update', 'fleet_software_update', ctx)
    result = client.delete_fsu_readiness_check(
        fsu_readiness_check_id=fsu_readiness_check_id,
        **kwargs
    )
    if wait_for_state:
...
@fsu_readiness_check_group.command(name=cli_util.override('fleet_software_update.get_fsu_readiness_check.command_name', 'get'), help=u"""Gets a Exadata Fleet Update Readiness Check by identifier. \n[Command Reference](getFsuReadinessCheck)""")
@cli_util.option('--fsu-readiness-check-id', required=True, help=u"""Unique Exadata Fleet Update Readiness Check identifier.""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'fleet_software_update', 'class': 'FsuReadinessCheck'})
@cli_util.wrap_exceptions
def get_fsu_readiness_check(ctx, from_json, fsu_readiness_check_id):
    ...
    kwargs['opc_request_id'] = cli_util.use_or_generate_request_id(ctx.obj['request_id'])
    client = cli_util.build_client('fleet_software_update', 'fleet_software_update', ctx)
    result = client.get_fsu_readiness_check(
        fsu_readiness_check_id=fsu_readiness_check_id,
        **kwargs
    )
    cli_util.render_response(result, ctx)
...
@fsu_readiness_check_summary_group.command(name=cli_util.override('fleet_software_update.list_fsu_readiness_checks.command_name', 'list-fsu-readiness-checks'), help=u"""Returns a list of Exadata Fleet Update Readiness Checks resources in the specified compartment. \n[Command Reference](listFsuReadinessChecks)""")
@cli_util.option('--compartment-id', required=True, help=u"""The ID of the compartment in which to list resources.""")
@cli_util.option('--resource-id', help=u"""The [OCID] of the resource related to the Exadata Fleet Update Readiness Check.""")
@cli_util.option('--lifecycle-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "NEEDS_ATTENTION", "SUCCEEDED", "WAITING", "CANCELING", "CANCELED", "DELETING", "DELETED"]), help=u"""A filter to return only resources whose lifecycleState matches the specified lifecycleState.""")
@cli_util.option('--display-name', help=u"""A filter to return only resources that match the entire display name given.""")
@cli_util.option('--type', type=custom_types.CliCaseInsensitiveChoice(["TARGET"]), help=u"""A filter to return only resources whose type matches the specified type.""")
@cli_util.option('--limit', type=click.INT, help=u"""The maximum number of items to return.""")
@cli_util.option('--page', help=u"""A token representing the position at which to start retrieving results. This must come from the `opc-next-page` header field of a previous response.""")
@cli_util.option('--sort-order', type=custom_types.CliCaseInsensitiveChoice(["ASC", "DESC"]), help=u"""The sort order to use, either 'ASC' or 'DESC'.""")
@cli_util.option('--sort-by', type=custom_types.CliCaseInsensitiveChoice(["timeCreated", "displayName"]), help=u"""The field to sort by. Only one sort order may be provided. Default order for timeCreated is descending. Default order for displayName is ascending.""")
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'fleet_software_update', 'class': 'FsuReadinessCheckCollection'})
@cli_util.wrap_exceptions
def list_fsu_readiness_checks(ctx, from_json, all_pages, page_size, compartment_id, resource_id, lifecycle_state, display_name, type, limit, page, sort_order, sort_by):
    ...
    if all_pages:
        ...
        result = cli_util.list_call_get_all_results(
            client.list_fsu_readiness_checks,
            compartment_id=compartment_id,
            **kwargs
        )
    elif limit is not None:
        ...
        result = client.list_fsu_readiness_checks(
            compartment_id=compartment_id,
            **kwargs
        )
    cli_util.render_response(result, ctx)
...
@fsu_readiness_check_group.command(name=cli_util.override('fleet_software_update.update_fsu_readiness_check.command_name', 'update'), help=u"""Updates the Exadata Fleet Update Readiness Check identified by the ID. \n[Command Reference](updateFsuReadinessCheck)""")
@cli_util.option('--fsu-readiness-check-id', required=True, help=u"""Unique Exadata Fleet Update Readiness Check identifier.""")
@cli_util.option('--display-name', help=u"""Updated display name for the Exadata Fleet Update Readiness Check resource.""")
@cli_util.option('--freeform-tags', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{\"bar-key\": \"value\"}`""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--defined-tags', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--force', help="""Perform update without prompting for confirmation.""", is_flag=True)
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "NEEDS_ATTENTION", "SUCCEEDED", "WAITING", "CANCELING", "CANCELED", "DELETING", "DELETED"]), multiple=True, help="""This operation creates, modifies or deletes a resource that has a defined lifecycle state. Specify this option to perform the action and then wait until the resource reaches a given lifecycle state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state DELETED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the resource to reach the lifecycle state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the resource has reached the lifecycle state defined by --wait-for-state. Defaults to 30 seconds.""")
@json_skeleton_utils.get_cli_json_input_option({'freeform-tags': {'module': 'fleet_software_update', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'fleet_software_update', 'class': 'dict(str, dict(str, object))'}})
@cli_util.help_option
...
def update_fsu_readiness_check(ctx, from_json, force, wait_for_state, max_wait_seconds, wait_interval_seconds, fsu_readiness_check_id, display_name, freeform_tags, defined_tags, if_match):
    ...
    client = cli_util.build_client('fleet_software_update', 'fleet_software_update', ctx)
    result = client.update_fsu_readiness_check(
        fsu_readiness_check_id=fsu_readiness_check_id,
        update_fsu_readiness_check_details=_details,
        **kwargs
    )
    if wait_for_state:

        if hasattr(client, 'get_fsu_readiness_check') and callable(getattr(client, 'get_fsu_readiness_check')):
            try:
                wait_period_kwargs = {}
                if max_wait_seconds is not None:
                    wait_period_kwargs['max_wait_seconds'] = max_wait_seconds
                ...
                click.echo('Action completed. Waiting until the resource has entered state: {}'.format(wait_for_state), file=sys.stderr)
                result = oci.wait_until(client, client.get_fsu_readiness_check(result.data.id), 'lifecycle_state', wait_for_state, **wait_period_kwargs)
            except oci.exceptions.MaximumWaitTimeExceeded as e:
                # If we fail, we should show an error, but we should still provide the information to the customer
                click.echo('Failed to wait until the resource entered the specified state. Outputting last known resource state', file=sys.stderr)
                cli_util.render_response(result, ctx)
