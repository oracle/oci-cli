...
This option is a JSON list with items of type SubnetSet.  For documentation on SubnetSet please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/kafkacluster/20240901/datatypes/SubnetSet.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
