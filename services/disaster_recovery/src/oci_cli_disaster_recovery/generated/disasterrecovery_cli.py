...
def delete_automatic_dr_configuration(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, automatic_dr_configuration_id, if_match):
    ...
    if isinstance(automatic_dr_configuration_id, str) and len(automatic_dr_configuration_id.strip()) == 0:
...
This option is a JSON list with items of type UpdateDrPlanGroupDetails.  For documentation on UpdateDrPlanGroupDetails please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/disasterrecovery/20220125/datatypes/UpdateDrPlanGroupDetails.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--freeform-tags', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
