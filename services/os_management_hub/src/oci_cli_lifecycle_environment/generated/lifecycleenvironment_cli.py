...
@click.command(cli_util.override('lifecycle_environment.lifecycle_environment_root_group.command_name', 'lifecycle-environment'), cls=CommandGroupWithAlias, help=cli_util.override('lifecycle_environment.lifecycle_environment_root_group.help', """Use the OS Management Hub API to manage and monitor updates and patches for the operating system environments in your private data centers through a single management console. For more information, see [Overview of OS Management Hub].
Use the table of contents and search tool to explore the  OS Management Hub API."""), short_help=cli_util.override('lifecycle_environment.lifecycle_environment_root_group.short_help', """OS Management Hub API"""))
