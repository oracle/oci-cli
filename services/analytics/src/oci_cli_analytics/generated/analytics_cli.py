...
@analytics_instance_group.command(name=cli_util.override('analytics.change_analytics_instance_compartment.command_name', 'change-compartment'), help=u"""Change the compartment of an Analytics instance. The operation is long-running and creates a new work request. \n[Command Reference](changeAnalyticsInstanceCompartment)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
...
@analytics_instance_group.command(name=cli_util.override('analytics.change_analytics_instance_network_endpoint.command_name', 'change-analytics-instance-network-endpoint'), help=u"""Change the network endpoint for an Analytics instance. The operation is long-running and creates a new work request. \n[Command Reference](changeAnalyticsInstanceNetworkEndpoint)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
...
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource.  The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--network-endpoint-details-network-security-group-ids', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Network Security Group OCIDs for the Analytics instance.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state CANCELED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
...
This option is a JSON list with items of type VirtualCloudNetwork.  For documentation on VirtualCloudNetwork please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/analytics/20190331/datatypes/VirtualCloudNetwork.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
@analytics_instance_group.command(name=cli_util.override('analytics.create_analytics_instance.command_name', 'create'), help=u"""Create a new Analytics instance in the specified compartment. The operation is long-running and creates a new work request. \n[Command Reference](createAnalyticsInstance)""")
@cli_util.option('--name', required=True, help=u"""The name of the Analytics instance. This name must be unique in the tenancy and can't be changed. The name must start with a letter and can contain only letters, numbers and dash (-).""")
@cli_util.option('--compartment-id', required=True, help=u"""The OCID of the compartment.""")
@cli_util.option('--feature-set', required=True, type=custom_types.CliCaseInsensitiveChoice(["SELF_SERVICE_ANALYTICS", "ENTERPRISE_ANALYTICS"]), help=u"""The feature set. Either `SELF_SERVICE_ANALYTICS` (Professional Edition) or `ENTERPRISE_ANALYTICS` (Enterprise Edition).""")
...
@cli_util.option('--update-channel', type=custom_types.CliCaseInsensitiveChoice(["REGULAR", "EARLY", "PHASE_2", "PHASE_1"]), help=u"""The Analytics instance update cycle.""")
@cli_util.option('--kms-key-id', help=u"""OCID of the OCI Vault Key encrypting the customer data stored in this Analytics instance. A null value indicates that the default Oracle-managed encryption is used.""")
@cli_util.option('--domain-id', help=u"""The OCID of the identity domain to use for the new Analytics instance. For example: ocid1.domain.oc1..ocid1.domain.oc1..aaaaaa111111bbbbbb222222cccccc333333dddddd444444eeeeee5555.""")
@cli_util.option('--admin-user', help=u"""The Analytics instance administrator user. This must be the user name (not OCID) of a user in the nominated identity domain. For example: john.smith@example.com.""")
@cli_util.option('--feature-bundle', type=custom_types.CliCaseInsensitiveChoice(["FAW_PAID", "FAW_FREE", "FDI_BASE", "EE_EMBEDDED", "SE_EMBEDDED"]), help=u"""The feature set of an Analytics instance.""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state CANCELED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
...
@analytics_instance_group.command(name=cli_util.override('analytics.create_private_access_channel.command_name', 'create-private-access-channel'), help=u"""Create an private access channel for the Analytics instance. The operation is long-running and creates a new work request. \n[Command Reference](createPrivateAccessChannel)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--display-name', required=True, help=u"""Display name of the private access channel.""")
@cli_util.option('--vcn-id', required=True, help=u"""OCID of the customer VCN peered with the private access channel.""")
@cli_util.option('--subnet-id', required=True, help=u"""OCID of the customer subnet connected to the private access channel.""")
...
This option is a JSON list with items of type PrivateSourceScanHost.  For documentation on PrivateSourceScanHost please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/analytics/20190331/datatypes/PrivateSourceScanHost.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--network-security-group-ids', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Network Security Group OCIDs for the Analytics instance.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state CANCELED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
...
@analytics_instance_group.command(name=cli_util.override('analytics.create_resource_group.command_name', 'create-resource-group'), help=u"""Create a new resource group for the instance \n[Command Reference](createResourceGroup)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--resource-name', required=True, help=u"""Meaningful name of resource group for end user""")
@cli_util.option('--capacity', required=True, type=click.INT, help=u"""The capacity (in OCPU's) to be allocated for this resource.""")
@cli_util.option('--display-name', help=u"""Meaningful name of resource group for end user""")
@cli_util.option('--description', help=u"""Optional description of the resource group""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state CANCELED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'analytics', 'class': 'InstanceResourceGroup'})
@cli_util.wrap_exceptions
def create_resource_group(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, analytics_instance_id, resource_name, capacity, display_name, description):
    ...
    result = client.create_resource_group(
        analytics_instance_id=analytics_instance_id,
        create_resource_group_details=_details,
        **kwargs
    )
    if wait_for_state:
...
@analytics_instance_group.command(name=cli_util.override('analytics.create_vanity_url.command_name', 'create-vanity-url'), help=u"""Allows you to specify a custom host name to be used to access the Analytics instance.  You must set up a DNS entry and certificate for this host in advance. \n[Command Reference](createVanityUrl)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--hosts', required=True, type=custom_types.CLI_COMPLEX_TYPE, help=u"""List of fully-qualified hostnames supported by this vanity URL definition (maximum of 3).""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
@cli_util.option('--ca-certificate', required=True, help=u"""PEM CA certificates for HTTPS connections. This may include multiple PEM certificates.""")
@cli_util.option('--description', help=u"""Optional description.""")
...
@analytics_instance_group.command(name=cli_util.override('analytics.delete_analytics_instance.command_name', 'delete'), help=u"""Deletes the specified Analytics instance. The operation is long-running and creates a new work request. \n[Command Reference](deleteAnalyticsInstance)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource.  The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
...
@analytics_instance_group.command(name=cli_util.override('analytics.delete_private_access_channel.command_name', 'delete-private-access-channel'), help=u"""Delete a private access channel with a given unique identifier key, for an Analytics instance. \n[Command Reference](deletePrivateAccessChannel)""")
...
@analytics_instance_group.command(name=cli_util.override('analytics.delete_resource_group.command_name', 'delete-resource-group'), help=u"""Allows deleting a previously created resource group. \n[Command Reference](deleteResourceGroup)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--analytics-instance-resource-group-id', required=True, help=u"""Specify unique id of a resource group within an Analytics instance.""")
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource.  The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.confirm_delete_option
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state CANCELED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
...
def delete_resource_group(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, analytics_instance_id, analytics_instance_resource_group_id, if_match):
    ...
    kwargs['opc_request_id'] = cli_util.use_or_generate_request_id(ctx.obj['request_id'])
    client = cli_util.build_client('analytics', 'analytics', ctx)
    result = client.delete_resource_group(
        analytics_instance_id=analytics_instance_id,
        analytics_instance_resource_group_id=analytics_instance_resource_group_id,
        **kwargs
    )
    if wait_for_state:
...
@analytics_instance_group.command(name=cli_util.override('analytics.delete_vanity_url.command_name', 'delete-vanity-url'), help=u"""Deletes a previously created vanity URL. \n[Command Reference](deleteVanityUrl)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
...
@work_request_group.command(name=cli_util.override('analytics.delete_work_request.command_name', 'delete'), help=u"""Cancel a work request that hasn't started yet. \n[Command Reference](deleteWorkRequest)""")
...
@analytics_instance_group.command(name=cli_util.override('analytics.get_analytics_instance.command_name', 'get'), help=u"""Information about a specific Analytics instance. \n[Command Reference](getAnalyticsInstance)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
@click.pass_context
...
@analytics_instance_group.command(name=cli_util.override('analytics.get_private_access_channel.command_name', 'get-private-access-channel'), help=u"""Retrieve private access channel for the specified Analytics Instance. \n[Command Reference](getPrivateAccessChannel)""")
@cli_util.option('--private-access-channel-key', required=True, help=u"""The unique identifier key of the private access channel.""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
...
@analytics_instance_group.command(name=cli_util.override('analytics.get_resource_group.command_name', 'get-resource-group'), help=u"""Get details of a resource group for an instance \n[Command Reference](getResourceGroup)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--analytics-instance-resource-group-id', required=True, help=u"""Specify unique id of a resource group within an Analytics instance.""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
...
@analytics_instance_group.command(name=cli_util.override('analytics.list_resource_groups.command_name', 'list-resource-groups'), help=u"""List resource groups associated with an instance. \n[Command Reference](listResourceGroups)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--name', help=u"""A filter to return only resources that match the given name exactly.""")
@cli_util.option('--limit', type=click.INT, help=u"""For list pagination. The maximum number of results per page, or items to return in a paginated \"List\" call. For important details about how pagination works, see [List Pagination].
...
Example: `50`""")
@cli_util.option('--page', help=u"""For list pagination. The value of the `opc-next-page` response header from the previous \"List\" call. For important details about how pagination works, see [List Pagination].""")
@cli_util.option('--sort-by', type=custom_types.CliCaseInsensitiveChoice(["id", "resourceName", "displayName", "description", "capacity", "status"]), help=u"""The field to sort by (one column only). Default sort order is default group first, then sort by resource name, ascending.""")
@cli_util.option('--sort-order', type=custom_types.CliCaseInsensitiveChoice(["ASC", "DESC"]), help=u"""The sort order to use, either ascending (`ASC`) or descending (`DESC`).""")
@cli_util.option('--all', 'all_pages', is_flag=True, help="""Fetches all pages of results. If you provide this option, then you cannot provide the --limit option.""")
@cli_util.option('--page-size', type=click.INT, help="""When fetching results, the number of results to fetch per call. Only valid when used with --all or --limit, and ignored otherwise.""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'analytics', 'class': 'list[InstanceResourceGroupSummary]'})
@cli_util.wrap_exceptions
def list_resource_groups(ctx, from_json, all_pages, page_size, analytics_instance_id, name, limit, page, sort_by, sort_order):
...
@analytics_instance_group.command(name=cli_util.override('analytics.scale_analytics_instance.command_name', 'scale'), help=u"""Scale an Analytics instance up or down. The operation is long-running and creates a new work request. \n[Command Reference](scaleAnalyticsInstance)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--capacity', required=True, type=custom_types.CLI_COMPLEX_TYPE, help=u"""""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource.  The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state CANCELED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
...
@analytics_instance_group.command(name=cli_util.override('analytics.set_kms_key.command_name', 'set-kms-key'), help=u"""Encrypts the customer data of this Analytics instance using either a customer OCI vault key or default Oracle-managed key. \n[Command Reference](setKmsKey)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--kms-key-id', required=True, help=u"""OCID of the OCI vault key encrypting the customer data stored in this Analytics instance. An empty value indicates the default Oracle-managed encryption (this API doesn't support null).""")
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource.  The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state CANCELED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
...
@analytics_instance_group.command(name=cli_util.override('analytics.start_analytics_instance.command_name', 'start'), help=u"""Starts the specified Analytics instance. The operation is long-running and creates a new work request. \n[Command Reference](startAnalyticsInstance)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource.  The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state CANCELED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
...
@analytics_instance_group.command(name=cli_util.override('analytics.stop_analytics_instance.command_name', 'stop'), help=u"""Stop the specified Analytics instance. The operation is long-running and creates a new work request. \n[Command Reference](stopAnalyticsInstance)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource.  The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "FAILED", "SUCCEEDED", "CANCELING", "CANCELED"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state CANCELED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
...
@cli_util.option('--vcn-id', help=u"""OCID of the customer VCN peered with the private access channel.""")
@cli_util.option('--subnet-id', help=u"""OCID of the customer subnet connected to the private access channel.""")
@cli_util.option('--private-source-dns-zones', type=custom_types.CLI_COMPLEX_TYPE, help=u"""List of private source DNS zones registered with the private access channel. The  datasource hostnames from these DNS zones / domains will be resolved in the peered VCN for access from  the Analytics instance. Minimum 1 private source is required. Maximum 30 private source DNS zones can be registered.

This option is a JSON list with items of type PrivateSourceDnsZone.  For documentation on PrivateSourceDnsZone please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/analytics/20190331/datatypes/PrivateSourceDnsZone.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--private-source-scan-hosts', type=custom_types.CLI_COMPLEX_TYPE, help=u"""List of private source database SCAN hosts registered with the private access channel for access from the Analytics instance.
...
@analytics_instance_group.command(name=cli_util.override('analytics.update_resource_group.command_name', 'update-resource-group'), help=u"""Update any fields in a resource group \n[Command Reference](updateResourceGroup)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--analytics-instance-resource-group-id', required=True, help=u"""Specify unique id of a resource group within an Analytics instance.""")
@cli_util.option('--resource-name', required=True, help=u"""Meaningful name of resource group for end user""")
@cli_util.option('--capacity', required=True, type=click.INT, help=u"""The capacity (in OCPU's) to be allocated for this resource.""")
...
def update_resource_group(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, analytics_instance_id, analytics_instance_resource_group_id, resource_name, capacity, display_name, description, if_match):
    ...
    client = cli_util.build_client('analytics', 'analytics', ctx)
    result = client.update_resource_group(
        analytics_instance_id=analytics_instance_id,
        analytics_instance_resource_group_id=analytics_instance_resource_group_id,
        update_resource_group_details=_details,
        **kwargs
    )
    if wait_for_state:
...
@analytics_instance_group.command(name=cli_util.override('analytics.update_vanity_url.command_name', 'update-vanity-url'), help=u"""Uploads a new certificate for a vanity URL. Required before the current certificate expires. \n[Command Reference](updateVanityUrl)""")
@cli_util.option('--analytics-instance-id', required=True, help=u"""The OCID of the Analytics instance.""")
@cli_util.option('--vanity-url-key', required=True, help=u"""Specify unique identifier key of a vanity URL to update or delete.""")
@cli_util.option('--private-key', required=True, help=u"""PEM private key for HTTPS connections.""")
@cli_util.option('--public-certificate', required=True, help=u"""PEM certificate for HTTPS connections.""")
