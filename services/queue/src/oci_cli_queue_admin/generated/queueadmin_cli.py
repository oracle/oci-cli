...
@click.command(cli_util.override('queue_admin.work_request_summary_collection_group.command_name', 'work-request-summary-collection'), cls=CommandGroupWithAlias, help="""Results of a workRequest search. Contains both WorkRequest items and other information, such as metadata.""")
@cli_util.help_option_group
def work_request_summary_collection_group():
    pass


@click.command(cli_util.override('queue_admin.queue_collection_group.command_name', 'queue-collection'), cls=CommandGroupWithAlias, help="""Results of a queue search. Contains both QueueSummary items and other information, such as metadata.""")
@cli_util.help_option_group
def queue_collection_group():
    pass


@click.command(cli_util.override('queue_admin.work_request_group.command_name', 'work-request'), cls=CommandGroupWithAlias, help="""A description of workrequest status""")
@cli_util.help_option_group
...
@click.command(cli_util.override('queue_admin.work_request_log_entry_collection_group.command_name', 'work-request-log-entry-collection'), cls=CommandGroupWithAlias, help="""Results of a workRequestLog search. Contains both workRequestLog items and other information, such as metadata.""")
@cli_util.help_option_group
...
queue_admin_root_group.add_command(work_request_group)
queue_admin_root_group.add_command(queue_group)
...
def change_queue_compartment(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, queue_id, compartment_id, if_match):
    ...
    result = client.change_queue_compartment(
        queue_id=queue_id,
        change_queue_compartment_details=_details,
        **kwargs
    )
    if wait_for_state:
...
def create_queue(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, display_name, compartment_id, retention_in_seconds, visibility_in_seconds, timeout_in_seconds, dead_letter_queue_delivery_count, custom_encryption_key_id, freeform_tags, defined_tags):
    ...
    if retention_in_seconds is not None:
        _details['retentionInSeconds'] = retention_in_seconds
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'queue', 'class': 'Queue'})
@cli_util.wrap_exceptions
...
@work_request_group.command(name=cli_util.override('queue_admin.get_work_request.command_name', 'get'), help=u"""Gets the status of the work request with the given ID. \n[Command Reference](getWorkRequest)""")
@cli_util.option('--work-request-id', required=True, help=u"""The ID of the asynchronous request.""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'queue', 'class': 'WorkRequest'})
@cli_util.wrap_exceptions
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'queue', 'class': 'QueueCollection'})
@cli_util.wrap_exceptions
def list_queues(ctx, from_json, all_pages, page_size, compartment_id, lifecycle_state, display_name, id, limit, page, sort_order, sort_by):
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'queue', 'class': 'WorkRequestErrorCollection'})
@cli_util.wrap_exceptions
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'queue', 'class': 'WorkRequestLogEntryCollection'})
@cli_util.wrap_exceptions
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'queue', 'class': 'WorkRequestSummaryCollection'})
@cli_util.wrap_exceptions
