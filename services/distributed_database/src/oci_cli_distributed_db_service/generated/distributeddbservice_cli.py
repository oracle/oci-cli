...
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@json_skeleton_utils.get_cli_json_input_option({'notification-topic-ids': {'module': 'distributed_database', 'class': 'list[string]'}, 'stream-ids': {'module': 'distributed_database', 'class': 'list[string]'}})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'notification-topic-ids': {'module': 'distributed_database', 'class': 'list[string]'}, 'stream-ids': {'module': 'distributed_database', 'class': 'list[string]'}}, output_type={'module': 'distributed_database', 'class': 'DistributedDatabaseAutoResourceManagementDetails'})
@cli_util.wrap_exceptions
...
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
@json_skeleton_utils.get_cli_json_input_option({'private-endpoint-ids': {'module': 'distributed_database', 'class': 'list[string]'}, 'notification-topic-ids': {'module': 'distributed_database', 'class': 'list[string]'}, 'composite-raft-shard-spaces': {'module': 'distributed_database', 'class': 'list[CreateCompositeRaftShardSpaceDetails]'}, 'composite-data-guard-shard-spaces': {'module': 'distributed_database', 'class': 'list[CreateCompositeDataGuardShardSpaceDetails]'}, 'system-raft-clusters': {'module': 'distributed_database', 'class': 'list[CreateSystemRaftClusterDetails]'}, 'system-data-guard-databases': {'module': 'distributed_database', 'class': 'CreateSystemDataGuardDatabaseDetails'}, 'user-shard-spaces': {'module': 'distributed_database', 'class': 'list[CreateUserShardSpaceDetails]'}, 'catalog-details': {'module': 'distributed_database', 'class': 'list[CreateDistributedDatabaseCatalogDetails]'}, 'db-backup-config': {'module': 'distributed_database', 'class': 'DistributedDbBackupConfig'}, 'vcn-nsg-ids': {'module': 'distributed_database', 'class': 'list[VcnNsgIdsDetails]'}, 'freeform-tags': {'module': 'distributed_database', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'distributed_database', 'class': 'dict(str, dict(str, object))'}})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'private-endpoint-ids': {'module': 'distributed_database', 'class': 'list[string]'}, 'notification-topic-ids': {'module': 'distributed_database', 'class': 'list[string]'}, 'composite-raft-shard-spaces': {'module': 'distributed_database', 'class': 'list[CreateCompositeRaftShardSpaceDetails]'}, 'composite-data-guard-shard-spaces': {'module': 'distributed_database', 'class': 'list[CreateCompositeDataGuardShardSpaceDetails]'}, 'system-raft-clusters': {'module': 'distributed_database', 'class': 'list[CreateSystemRaftClusterDetails]'}, 'system-data-guard-databases': {'module': 'distributed_database', 'class': 'CreateSystemDataGuardDatabaseDetails'}, 'user-shard-spaces': {'module': 'distributed_database', 'class': 'list[CreateUserShardSpaceDetails]'}, 'catalog-details': {'module': 'distributed_database', 'class': 'list[CreateDistributedDatabaseCatalogDetails]'}, 'db-backup-config': {'module': 'distributed_database', 'class': 'DistributedDbBackupConfig'}, 'vcn-nsg-ids': {'module': 'distributed_database', 'class': 'list[VcnNsgIdsDetails]'}, 'freeform-tags': {'module': 'distributed_database', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'distributed_database', 'class': 'dict(str, dict(str, object))'}}, output_type={'module': 'distributed_database', 'class': 'DistributedDatabase'})
@cli_util.wrap_exceptions
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'distributed_database', 'class': 'DistributedDatabaseRuChangeLog'})
@cli_util.wrap_exceptions
...
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
@json_skeleton_utils.get_cli_json_input_option({'database-details': {'module': 'distributed_database', 'class': 'list[RotateDistributedDatabaseDetails]'}})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'database-details': {'module': 'distributed_database', 'class': 'list[RotateDistributedDatabaseDetails]'}})
@cli_util.wrap_exceptions
...
@json_skeleton_utils.get_cli_json_input_option({'notification-topic-ids': {'module': 'distributed_database', 'class': 'list[string]'}, 'freeform-tags': {'module': 'distributed_database', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'distributed_database', 'class': 'dict(str, dict(str, object))'}})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'notification-topic-ids': {'module': 'distributed_database', 'class': 'list[string]'}, 'freeform-tags': {'module': 'distributed_database', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'distributed_database', 'class': 'dict(str, dict(str, object))'}}, output_type={'module': 'distributed_database', 'class': 'DistributedDatabase'})
@cli_util.wrap_exceptions
