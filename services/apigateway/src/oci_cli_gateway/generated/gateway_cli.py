...
@cli_util.wrap_exceptions
def create_gateway(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, endpoint_type, subnet_id, display_name, freeform_tags, defined_tags):
...
@cli_util.wrap_exceptions
def list_gateways(ctx, from_json, all_pages, page_size, compartment_id, display_name, lifecycle_state, limit, page, sort_order, sort_by):
...
@cli_util.wrap_exceptions
def update_gateway(ctx, from_json, force, wait_for_state, max_wait_seconds, wait_interval_seconds, gateway_id, display_name, freeform_tags, defined_tags, if_match):
