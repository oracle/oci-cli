...
@click.command(cli_util.override('refresh_activity.refresh_activity_root_group.command_name', 'refresh-activity'), cls=CommandGroupWithAlias, help=cli_util.override('refresh_activity.refresh_activity_root_group.help', """Use the Fusion Applications Environment Management API to manage the environments where your Fusion Applications run. For more information, see the [Fusion Applications Environment Management documentation]."""), short_help=cli_util.override('refresh_activity.refresh_activity_root_group.short_help', """Fusion Applications Environment Management API"""))
@cli_util.help_option_group
def refresh_activity_root_group():
    pass


@click.command(cli_util.override('refresh_activity.refresh_activity_group.command_name', 'refresh-activity'), cls=CommandGroupWithAlias, help="""An environment refresh copies data from a source environment to a target environment, making a copy of the source environment onto the target environment. For more information, see [Refreshing an Environment].""")
@cli_util.help_option_group
def refresh_activity_group():
    pass


@click.command(cli_util.override('refresh_activity.time_available_for_refresh_group.command_name', 'time-available-for-refresh'), cls=CommandGroupWithAlias, help="""one available refresh time.""")
@cli_util.help_option_group
def time_available_for_refresh_group():
    pass


@click.command(cli_util.override('refresh_activity.create_refresh_activity_details_group.command_name', 'create-refresh-activity-details'), cls=CommandGroupWithAlias, help="""The information about current refresh.""")
@cli_util.help_option_group
def create_refresh_activity_details_group():
    pass


fusion_apps_service_cli.fusion_apps_service_group.add_command(refresh_activity_root_group)
refresh_activity_root_group.add_command(refresh_activity_group)
refresh_activity_root_group.add_command(time_available_for_refresh_group)
refresh_activity_root_group.add_command(create_refresh_activity_details_group)


@create_refresh_activity_details_group.command(name=cli_util.override('refresh_activity.create_refresh_activity.command_name', 'create-refresh-activity'), help=u"""Creates a new RefreshActivity. \n[Command Reference](createRefreshActivity)""")
...
def create_refresh_activity(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, fusion_environment_id, source_fusion_environment_id):
    ...
    client = cli_util.build_client('fusion_apps', 'refresh_activity', ctx)
...
@refresh_activity_group.command(name=cli_util.override('refresh_activity.get_refresh_activity.command_name', 'get'), help=u"""Gets a RefreshActivity by identifier \n[Command Reference](getRefreshActivity)""")
@cli_util.option('--fusion-environment-id', required=True, help=u"""unique FusionEnvironment identifier""")
...
@refresh_activity_group.command(name=cli_util.override('refresh_activity.list_refresh_activities.command_name', 'list'), help=u"""Returns a list of RefreshActivities. \n[Command Reference](listRefreshActivities)""")
@cli_util.option('--fusion-environment-id', required=True, help=u"""unique FusionEnvironment identifier""")
...
@time_available_for_refresh_group.command(name=cli_util.override('refresh_activity.list_time_available_for_refreshes.command_name', 'list'), help=u"""Gets available refresh time for this fusion environment \n[Command Reference](listTimeAvailableForRefreshes)""")
@cli_util.option('--fusion-environment-id', required=True, help=u"""unique FusionEnvironment identifier""")
@cli_util.option('--limit', type=click.INT, help=u"""The maximum number of items to return.""")
@cli_util.option('--page', help=u"""The page token representing the page at which to start retrieving results. This is usually retrieved from a previous list call.""")
@cli_util.option('--sort-order', type=custom_types.CliCaseInsensitiveChoice(["ASC", "DESC"]), help=u"""The sort order to use, either 'asc' or 'desc'.""")
