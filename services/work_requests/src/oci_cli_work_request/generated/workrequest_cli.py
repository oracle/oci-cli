...
@cli.command(cli_util.override('work_requests_root_group.command_name', 'work-requests'), cls=CommandGroupWithAlias, help=cli_util.override('work_requests_root_group.help', """A description of the work requests API"""), short_help=cli_util.override('work_requests_root_group.short_help', """Work Requests API"""))
