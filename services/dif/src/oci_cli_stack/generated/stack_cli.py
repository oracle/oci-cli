...
This option is a JSON list with items of type AdbDetail.  For documentation on AdbDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/AdbDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type GgcsDetail.  For documentation on GgcsDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/GgcsDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type DataflowDetail.  For documentation on DataflowDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/DataflowDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type ObjectStorageDetail.  For documentation on ObjectStorageDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/ObjectStorageDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type GenAiDetail.  For documentation on GenAiDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/GenAiDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type AiDataPlatformDetail.  For documentation on AiDataPlatformDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/AiDataPlatformDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--omk', type=custom_types.CLI_COMPLEX_TYPE, help=u"""OMK Details if omk is included in services to be added.

This option is a JSON list with items of type OmkDetail.  For documentation on OmkDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/OmkDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--oke', type=custom_types.CLI_COMPLEX_TYPE, help=u"""OKE Details if oke is included in services to be added.

This option is a JSON list with items of type OkeDetail.  For documentation on OkeDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/OkeDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type AdbArtifactsDetail.  For documentation on AdbArtifactsDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/AdbArtifactsDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--ggcs', type=custom_types.CLI_COMPLEX_TYPE, help=u"""GGCS artifact details if ggcs is included in the services.

This option is a JSON list with items of type GgcsArtifactsDetail.  For documentation on GgcsArtifactsDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/GgcsArtifactsDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type DataflowArtifactsDetail.  For documentation on DataflowArtifactsDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/DataflowArtifactsDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--omk', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Omk artifact details if omk is included in the services.

This option is a JSON list with items of type OmkArtifactsDetail.  For documentation on OmkArtifactsDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/OmkArtifactsDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--oke', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Oke artifact details if oke is included in the services.

This option is a JSON list with items of type OkeArtifactsDetail.  For documentation on OkeArtifactsDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/OkeArtifactsDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--if-match', help=u"""For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.""")
@cli_util.option('--wait-for-state', type=custom_types.CliCaseInsensitiveChoice(["ACCEPTED", "IN_PROGRESS", "WAITING", "NEEDS_ATTENTION", "FAILED", "SUCCEEDED", "CANCELLING", "CANCELLED"]), multiple=True, help="""This operation asynchronously creates, modifies or deletes a resource and uses a work request to track the progress of the operation. Specify this option to perform the action and then wait until the work request reaches a certain state. Multiple states can be specified, returning on the first state. For example, --wait-for-state ACCEPTED --wait-for-state CANCELLED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.""")
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
...
This option is a JSON list with items of type AdbUpdateDetail.  For documentation on AdbUpdateDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/AdbUpdateDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type GgcsUpdateDetail.  For documentation on GgcsUpdateDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/GgcsUpdateDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type DataflowUpdateDetail.  For documentation on DataflowUpdateDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/DataflowUpdateDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type ObjectStorageUpdateDetail.  For documentation on ObjectStorageUpdateDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/ObjectStorageUpdateDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
This option is a JSON list with items of type GenAiUpdateDetail.  For documentation on GenAiUpdateDetail please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/stack/20250830/datatypes/GenAiUpdateDetail.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--freeform-tags', type=custom_types.CLI_COMPLEX_TYPE, help=u"""Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags].
