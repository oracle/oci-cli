...
This option is a JSON list with items of type ResourceBundle.  For documentation on ResourceBundle please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/offer/20220901/datatypes/ResourceBundle.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
