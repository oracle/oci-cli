...
<b>Google AWS Key Resource:</b>&nbsp;&nbsp;The Oracle AWS Key Resource is used to register and manage a AWS Key within Oracle Cloud Infrastructure (OCI)."""), short_help=cli_util.override('oracle_db_azure_blob_mount.oracle_db_azure_blob_mount_root_group.short_help', """Oracle Database MultiCloud Data Plane Integration"""))
...
dbmulticloud_service_cli.dbmulticloud_service_group.add_command(oracle_db_azure_blob_mount_root_group)
...
def change_oracle_db_azure_blob_mount_compartment(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, oracle_db_azure_blob_mount_id, compartment_id, freeform_tags, defined_tags, system_tags, if_match):

    if isinstance(oracle_db_azure_blob_mount_id, six.string_types) and len(oracle_db_azure_blob_mount_id.strip()) == 0:
        raise click.UsageError('Parameter --oracle-db-azure-blob-mount-id cannot be whitespace or empty string')
    ...
    client = cli_util.build_client('dbmulticloud', 'oracle_db_azure_blob_mount', ctx)
    result = client.change_oracle_db_azure_blob_mount_compartment(
        oracle_db_azure_blob_mount_id=oracle_db_azure_blob_mount_id,
        change_oracle_db_azure_blob_mount_compartment_details=_details,
        **kwargs
    )
    if wait_for_state:
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'freeform-tags': {'module': 'dbmulticloud', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'dbmulticloud', 'class': 'dict(str, dict(str, object))'}}, output_type={'module': 'dbmulticloud', 'class': 'OracleDbAzureBlobMount'})
@cli_util.wrap_exceptions
def create_oracle_db_azure_blob_mount(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, display_name, oracle_db_azure_connector_id, oracle_db_azure_blob_container_id, freeform_tags, defined_tags, if_match):
    ...
    _details['oracleDbAzureBlobContainerId'] = oracle_db_azure_blob_container_id
    ...
    client = cli_util.build_client('dbmulticloud', 'oracle_db_azure_blob_mount', ctx)
    result = client.create_oracle_db_azure_blob_mount(
        create_oracle_db_azure_blob_mount_details=_details,
        **kwargs
    )
    if wait_for_state:
...
@cli_util.wrap_exceptions
def delete_oracle_db_azure_blob_mount(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, oracle_db_azure_blob_mount_id, if_match):
    ...
    kwargs['opc_request_id'] = cli_util.use_or_generate_request_id(ctx.obj['request_id'])
    client = cli_util.build_client('dbmulticloud', 'oracle_db_azure_blob_mount', ctx)
    result = client.delete_oracle_db_azure_blob_mount(
        oracle_db_azure_blob_mount_id=oracle_db_azure_blob_mount_id,
        **kwargs
    )
    if wait_for_state:
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'dbmulticloud', 'class': 'OracleDbAzureBlobMount'})
@cli_util.wrap_exceptions
def get_oracle_db_azure_blob_mount(ctx, from_json, oracle_db_azure_blob_mount_id, limit, page, sort_order):
    ...
    kwargs['opc_request_id'] = cli_util.use_or_generate_request_id(ctx.obj['request_id'])
    client = cli_util.build_client('dbmulticloud', 'oracle_db_azure_blob_mount', ctx)
    result = client.get_oracle_db_azure_blob_mount(
        oracle_db_azure_blob_mount_id=oracle_db_azure_blob_mount_id,
        **kwargs
    )
    cli_util.render_response(result, ctx)
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'dbmulticloud', 'class': 'OracleDbAzureBlobMountSummaryCollection'})
@cli_util.wrap_exceptions
def list_oracle_db_azure_blob_mounts(ctx, from_json, all_pages, page_size, compartment_id, display_name, oracle_db_azure_blob_mount_id, lifecycle_state, oracle_db_azure_blob_container_id, oracle_db_azure_connector_id, limit, page, sort_order, sort_by):
    ...
    if oracle_db_azure_blob_mount_id is not None:
        kwargs['oracle_db_azure_blob_mount_id'] = oracle_db_azure_blob_mount_id
    ...
    if all_pages:
        ...
        result = cli_util.list_call_get_all_results(
            client.list_oracle_db_azure_blob_mounts,
        ...
        result = client.list_oracle_db_azure_blob_mounts(
            compartment_id=compartment_id,
            **kwargs
        )
    cli_util.render_response(result, ctx)
...
@cli_util.wrap_exceptions
def update_oracle_db_azure_blob_mount(ctx, from_json, force, wait_for_state, max_wait_seconds, wait_interval_seconds, oracle_db_azure_blob_mount_id, compartment_id, display_name, oracle_db_azure_connector_id, oracle_db_azure_blob_container_id, freeform_tags, defined_tags, if_match):
    ...
    client = cli_util.build_client('dbmulticloud', 'oracle_db_azure_blob_mount', ctx)
    result = client.update_oracle_db_azure_blob_mount(
        oracle_db_azure_blob_mount_id=oracle_db_azure_blob_mount_id,
        update_oracle_db_azure_blob_mount_details=_details,
        **kwargs
    )
    if wait_for_state:
