...
<b>Oracle AWS Key Resource:</b>&nbsp;&nbsp;The Oracle AWS Key Resource is used to register and manage a AWS Key within Oracle Cloud Infrastructure (OCI)."""), short_help=cli_util.override('oracle_db_azure_connector.oracle_db_azure_connector_root_group.short_help', """Oracle Database MultiCloud Data Plane Integration"""))
