...
Using logging service, you can view a near real-time audit report of all actions performed by an Oracle operator."""), short_help=cli_util.override('operator_actions.operator_actions_root_group.short_help', """Operator Access Control API"""))
