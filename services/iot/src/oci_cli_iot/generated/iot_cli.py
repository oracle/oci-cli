...
This option is a JSON list with items of type DigitalTwinAdapterInboundRoute.  For documentation on DigitalTwinAdapterInboundRoute please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/iot/20250531/datatypes/DigitalTwinAdapterInboundRoute.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
