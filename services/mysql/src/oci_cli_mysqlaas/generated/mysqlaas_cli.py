...
@cli_util.option('--options', type=custom_types.CLI_COMPLEX_TYPE, help=u"""The MySQL options defined in the Configuration.

This option is a JSON list with items of type Option.  For documentation on Option please see our API reference: https://docs.oracle.com/en-us/iaas/api/#/en/mysqlaas/20190415/datatypes/Option.""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
@json_skeleton_utils.get_cli_json_input_option({'init-variables': {'module': 'mysql', 'class': 'InitializationVariables'}, 'variables': {'module': 'mysql', 'class': 'ConfigurationVariables'}, 'options': {'module': 'mysql', 'class': 'list[Option]'}, 'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'init-variables': {'module': 'mysql', 'class': 'InitializationVariables'}, 'variables': {'module': 'mysql', 'class': 'ConfigurationVariables'}, 'options': {'module': 'mysql', 'class': 'list[Option]'}, 'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}}, output_type={'module': 'mysql', 'class': 'Configuration'})
@cli_util.wrap_exceptions
def create_configuration(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, shape_name, description, display_name, init_variables, variables, options, parent_configuration_id, freeform_tags, defined_tags):
