...
@cli_util.option('--is-ipv6-enabled', type=click.BOOL, help=u"""Whether to allocate an IPv6 address at DB system creation from an IPv6 enabled subnet. When provided you may optionally provide an IPv6 prefix (ipv6AddressIpv6SubnetCidrPairDetails) of your choice to assign the IPv6 address from. If ipv6AddressIpv6SubnetCidrPairDetails is not provided then an IPv6 prefix is chosen for you.""")
@cli_util.option('--ipv6-address-ipv6-subnet-cidr-pair-details', type=custom_types.CLI_COMPLEX_TYPE, help=u"""""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
def create_db_system(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, shape_name, subnet_id, display_name, description, rest, database_console, is_highly_available, availability_domain, fault_domain, configuration_id, mysql_version, nsg_ids, security_attributes, admin_username, admin_password, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, is_ipv6_enabled, ipv6_address_ipv6_subnet_cidr_pair_details, port, port_x, backup_policy, source, maintenance, freeform_tags, defined_tags, deletion_policy, crash_recovery, database_management, secure_connections, encrypt_data, database_mode, access_mode, customer_contacts, read_endpoint, telemetry_configuration):
    ...
    if ipv6_address_ipv6_subnet_cidr_pair_details is not None:
        _details['ipv6AddressIpv6SubnetCidrPairDetails'] = cli_util.parse_json_parameter("ipv6_address_ipv6_subnet_cidr_pair_details", ipv6_address_ipv6_subnet_cidr_pair_details)
...
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'rest': {'module': 'mysql', 'class': 'CreateRestDetails'}, 'database-console': {'module': 'mysql', 'class': 'CreateDatabaseConsoleDetails'}, 'nsg-ids': {'module': 'mysql', 'class': 'list[string]'}, 'security-attributes': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'data-storage': {'module': 'mysql', 'class': 'DataStorageDetails'}, 'ipv6-address-ipv6-subnet-cidr-pair-details': {'module': 'mysql', 'class': 'Ipv6AddressIpv6SubnetCidrPairDetails'}, 'backup-policy': {'module': 'mysql', 'class': 'CreateBackupPolicyDetails'}, 'maintenance': {'module': 'mysql', 'class': 'CreateMaintenanceDetails'}, 'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'deletion-policy': {'module': 'mysql', 'class': 'CreateDeletionPolicyDetails'}, 'secure-connections': {'module': 'mysql', 'class': 'SecureConnectionDetails'}, 'encrypt-data': {'module': 'mysql', 'class': 'EncryptDataDetails'}, 'customer-contacts': {'module': 'mysql', 'class': 'list[CustomerContact]'}, 'read-endpoint': {'module': 'mysql', 'class': 'CreateReadEndpointDetails'}, 'telemetry-configuration': {'module': 'mysql', 'class': 'CreateTelemetryConfigurationDetails'}}, output_type={'module': 'mysql', 'class': 'DbSystem'})
@cli_util.wrap_exceptions
def create_db_system_create_db_system_source_from_backup_details(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, shape_name, subnet_id, source_backup_id, display_name, description, rest, database_console, is_highly_available, availability_domain, fault_domain, configuration_id, mysql_version, nsg_ids, security_attributes, admin_username, admin_password, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, is_ipv6_enabled, ipv6_address_ipv6_subnet_cidr_pair_details, port, port_x, backup_policy, maintenance, freeform_tags, defined_tags, deletion_policy, crash_recovery, database_management, secure_connections, encrypt_data, database_mode, access_mode, customer_contacts, read_endpoint, telemetry_configuration):
...
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'rest': {'module': 'mysql', 'class': 'CreateRestDetails'}, 'database-console': {'module': 'mysql', 'class': 'CreateDatabaseConsoleDetails'}, 'nsg-ids': {'module': 'mysql', 'class': 'list[string]'}, 'security-attributes': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'data-storage': {'module': 'mysql', 'class': 'DataStorageDetails'}, 'ipv6-address-ipv6-subnet-cidr-pair-details': {'module': 'mysql', 'class': 'Ipv6AddressIpv6SubnetCidrPairDetails'}, 'backup-policy': {'module': 'mysql', 'class': 'CreateBackupPolicyDetails'}, 'maintenance': {'module': 'mysql', 'class': 'CreateMaintenanceDetails'}, 'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'deletion-policy': {'module': 'mysql', 'class': 'CreateDeletionPolicyDetails'}, 'secure-connections': {'module': 'mysql', 'class': 'SecureConnectionDetails'}, 'encrypt-data': {'module': 'mysql', 'class': 'EncryptDataDetails'}, 'customer-contacts': {'module': 'mysql', 'class': 'list[CustomerContact]'}, 'read-endpoint': {'module': 'mysql', 'class': 'CreateReadEndpointDetails'}, 'telemetry-configuration': {'module': 'mysql', 'class': 'CreateTelemetryConfigurationDetails'}}, output_type={'module': 'mysql', 'class': 'DbSystem'})
@cli_util.wrap_exceptions
def create_db_system_create_db_system_source_from_none_details(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, shape_name, subnet_id, display_name, description, rest, database_console, is_highly_available, availability_domain, fault_domain, configuration_id, mysql_version, nsg_ids, security_attributes, admin_username, admin_password, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, is_ipv6_enabled, ipv6_address_ipv6_subnet_cidr_pair_details, port, port_x, backup_policy, maintenance, freeform_tags, defined_tags, deletion_policy, crash_recovery, database_management, secure_connections, encrypt_data, database_mode, access_mode, customer_contacts, read_endpoint, telemetry_configuration):
...
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'rest': {'module': 'mysql', 'class': 'CreateRestDetails'}, 'database-console': {'module': 'mysql', 'class': 'CreateDatabaseConsoleDetails'}, 'nsg-ids': {'module': 'mysql', 'class': 'list[string]'}, 'security-attributes': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'data-storage': {'module': 'mysql', 'class': 'DataStorageDetails'}, 'ipv6-address-ipv6-subnet-cidr-pair-details': {'module': 'mysql', 'class': 'Ipv6AddressIpv6SubnetCidrPairDetails'}, 'backup-policy': {'module': 'mysql', 'class': 'CreateBackupPolicyDetails'}, 'maintenance': {'module': 'mysql', 'class': 'CreateMaintenanceDetails'}, 'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'deletion-policy': {'module': 'mysql', 'class': 'CreateDeletionPolicyDetails'}, 'secure-connections': {'module': 'mysql', 'class': 'SecureConnectionDetails'}, 'encrypt-data': {'module': 'mysql', 'class': 'EncryptDataDetails'}, 'customer-contacts': {'module': 'mysql', 'class': 'list[CustomerContact]'}, 'read-endpoint': {'module': 'mysql', 'class': 'CreateReadEndpointDetails'}, 'telemetry-configuration': {'module': 'mysql', 'class': 'CreateTelemetryConfigurationDetails'}}, output_type={'module': 'mysql', 'class': 'DbSystem'})
@cli_util.wrap_exceptions
def create_db_system_create_db_system_source_import_from_url_details(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, shape_name, subnet_id, source_source_url, display_name, description, rest, database_console, is_highly_available, availability_domain, fault_domain, configuration_id, mysql_version, nsg_ids, security_attributes, admin_username, admin_password, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, is_ipv6_enabled, ipv6_address_ipv6_subnet_cidr_pair_details, port, port_x, backup_policy, maintenance, freeform_tags, defined_tags, deletion_policy, crash_recovery, database_management, secure_connections, encrypt_data, database_mode, access_mode, customer_contacts, read_endpoint, telemetry_configuration):
...
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'rest': {'module': 'mysql', 'class': 'CreateRestDetails'}, 'database-console': {'module': 'mysql', 'class': 'CreateDatabaseConsoleDetails'}, 'nsg-ids': {'module': 'mysql', 'class': 'list[string]'}, 'security-attributes': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'data-storage': {'module': 'mysql', 'class': 'DataStorageDetails'}, 'ipv6-address-ipv6-subnet-cidr-pair-details': {'module': 'mysql', 'class': 'Ipv6AddressIpv6SubnetCidrPairDetails'}, 'backup-policy': {'module': 'mysql', 'class': 'CreateBackupPolicyDetails'}, 'maintenance': {'module': 'mysql', 'class': 'CreateMaintenanceDetails'}, 'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'deletion-policy': {'module': 'mysql', 'class': 'CreateDeletionPolicyDetails'}, 'secure-connections': {'module': 'mysql', 'class': 'SecureConnectionDetails'}, 'encrypt-data': {'module': 'mysql', 'class': 'EncryptDataDetails'}, 'customer-contacts': {'module': 'mysql', 'class': 'list[CustomerContact]'}, 'read-endpoint': {'module': 'mysql', 'class': 'CreateReadEndpointDetails'}, 'telemetry-configuration': {'module': 'mysql', 'class': 'CreateTelemetryConfigurationDetails'}}, output_type={'module': 'mysql', 'class': 'DbSystem'})
@cli_util.wrap_exceptions
def create_db_system_create_db_system_source_from_pitr_details(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, shape_name, subnet_id, source_db_system_id, display_name, description, rest, database_console, is_highly_available, availability_domain, fault_domain, configuration_id, mysql_version, nsg_ids, security_attributes, admin_username, admin_password, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, is_ipv6_enabled, ipv6_address_ipv6_subnet_cidr_pair_details, port, port_x, backup_policy, maintenance, freeform_tags, defined_tags, deletion_policy, crash_recovery, database_management, secure_connections, encrypt_data, database_mode, access_mode, customer_contacts, read_endpoint, telemetry_configuration, source_recovery_point):
...
@db_system_status_group.command(name=cli_util.override('db_system.generate_db_system_status.command_name', 'generate'), help=u"""Initiates an asynchronous request to collect the current status of the specified DB System, including the status of any attached Channels (if requested). \n[Command Reference](generateDbSystemStatus)""")
@cli_util.option('--db-system-id', required=True, help=u"""The DB System [OCID].""")
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'channel-ids': {'module': 'mysql', 'class': 'list[string]'}}, output_type={'module': 'mysql', 'class': 'DbSystemStatus'})
@cli_util.wrap_exceptions
def generate_db_system_status(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, db_system_id, gtid_set_type, gtid_set_to_apply, channel_ids):
    ...
    if gtid_set_type is not None:
        _details['gtidSetType'] = gtid_set_type

    if gtid_set_to_apply is not None:
        _details['gtidSetToApply'] = gtid_set_to_apply

    if channel_ids is not None:
        _details['channelIds'] = cli_util.parse_json_parameter("channel_ids", channel_ids)

    client = cli_util.build_client('mysql', 'db_system', ctx)
    result = client.generate_db_system_status(
        db_system_id=db_system_id,
        generate_db_system_status_details=_details,
        **kwargs
    )
    if wait_for_state:
...
@db_system_status_group.command(name=cli_util.override('db_system.get_db_system_status.command_name', 'get'), help=u"""Returns the most up-to-date status of the specified DB System, including the status of any requested Channels. \n[Command Reference](getDbSystemStatus)""")
@cli_util.option('--db-system-id', required=True, help=u"""The DB System [OCID].""")
@json_skeleton_utils.get_cli_json_input_option({})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={}, output_type={'module': 'mysql', 'class': 'DbSystemStatus'})
@cli_util.wrap_exceptions
def get_db_system_status(ctx, from_json, db_system_id):
    ...
    kwargs['opc_request_id'] = cli_util.use_or_generate_request_id(ctx.obj['request_id'])
    client = cli_util.build_client('mysql', 'db_system', ctx)
    result = client.get_db_system_status(
        db_system_id=db_system_id,
        **kwargs
    )
    cli_util.render_response(result, ctx)
...
@cli_util.option('--is-ipv6-enabled', type=click.BOOL, help=u"""Whether to allocate an IPv6 address for the DB system in an IPv6 enabled subnet. When provided you may optionally provide an IPv6 prefix (ipv6AddressIpv6SubnetCidrPairDetails) of your choice to assign the IPv6 address from. If ipv6AddressIpv6SubnetCidrPairDetails is not provided then an IPv6 prefix is chosen for you.""")
@cli_util.option('--ipv6-address-ipv6-subnet-cidr-pair-details', type=custom_types.CLI_COMPLEX_TYPE, help=u"""""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
@cli_util.option('--port', type=click.INT, help=u"""The port for primary endpoint of the DB System to listen on.""")
@cli_util.option('--port-x', type=click.INT, help=u"""The TCP network port on which X Plugin listens for connections. This is the X Plugin equivalent of port.""")
@cli_util.option('--backup-policy', type=custom_types.CLI_COMPLEX_TYPE, help=u"""""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
@cli_util.option('--max-wait-seconds', type=click.INT, help="""The maximum time to wait for the work request to reach the state defined by --wait-for-state. Defaults to 1200 seconds.""")
@cli_util.option('--wait-interval-seconds', type=click.INT, help="""Check every --wait-interval-seconds to see whether the work request has reached the state defined by --wait-for-state. Defaults to 30 seconds.""")
@json_skeleton_utils.get_cli_json_input_option({'nsg-ids': {'module': 'mysql', 'class': 'list[string]'}, 'security-attributes': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'rest': {'module': 'mysql', 'class': 'UpdateRestDetails'}, 'database-console': {'module': 'mysql', 'class': 'UpdateDatabaseConsoleDetails'}, 'data-storage': {'module': 'mysql', 'class': 'DataStorageDetails'}, 'ipv6-address-ipv6-subnet-cidr-pair-details': {'module': 'mysql', 'class': 'Ipv6AddressIpv6SubnetCidrPairDetails'}, 'backup-policy': {'module': 'mysql', 'class': 'UpdateBackupPolicyDetails'}, 'maintenance': {'module': 'mysql', 'class': 'UpdateMaintenanceDetails'}, 'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'deletion-policy': {'module': 'mysql', 'class': 'UpdateDeletionPolicyDetails'}, 'secure-connections': {'module': 'mysql', 'class': 'SecureConnectionDetails'}, 'encrypt-data': {'module': 'mysql', 'class': 'EncryptDataDetails'}, 'customer-contacts': {'module': 'mysql', 'class': 'list[CustomerContact]'}, 'read-endpoint': {'module': 'mysql', 'class': 'UpdateReadEndpointDetails'}, 'telemetry-configuration': {'module': 'mysql', 'class': 'UpdateTelemetryConfigurationDetails'}})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'nsg-ids': {'module': 'mysql', 'class': 'list[string]'}, 'security-attributes': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'rest': {'module': 'mysql', 'class': 'UpdateRestDetails'}, 'database-console': {'module': 'mysql', 'class': 'UpdateDatabaseConsoleDetails'}, 'data-storage': {'module': 'mysql', 'class': 'DataStorageDetails'}, 'ipv6-address-ipv6-subnet-cidr-pair-details': {'module': 'mysql', 'class': 'Ipv6AddressIpv6SubnetCidrPairDetails'}, 'backup-policy': {'module': 'mysql', 'class': 'UpdateBackupPolicyDetails'}, 'maintenance': {'module': 'mysql', 'class': 'UpdateMaintenanceDetails'}, 'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'deletion-policy': {'module': 'mysql', 'class': 'UpdateDeletionPolicyDetails'}, 'secure-connections': {'module': 'mysql', 'class': 'SecureConnectionDetails'}, 'encrypt-data': {'module': 'mysql', 'class': 'EncryptDataDetails'}, 'customer-contacts': {'module': 'mysql', 'class': 'list[CustomerContact]'}, 'read-endpoint': {'module': 'mysql', 'class': 'UpdateReadEndpointDetails'}, 'telemetry-configuration': {'module': 'mysql', 'class': 'UpdateTelemetryConfigurationDetails'}})
@cli_util.wrap_exceptions
def update_db_system(ctx, from_json, force, wait_for_state, max_wait_seconds, wait_interval_seconds, db_system_id, display_name, description, subnet_id, nsg_ids, security_attributes, database_mode, access_mode, rest, database_console, is_highly_available, availability_domain, fault_domain, shape_name, mysql_version, configuration_id, admin_username, admin_password, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, is_ipv6_enabled, ipv6_address_ipv6_subnet_cidr_pair_details, port, port_x, backup_policy, maintenance, freeform_tags, defined_tags, deletion_policy, crash_recovery, database_management, secure_connections, encrypt_data, customer_contacts, read_endpoint, telemetry_configuration, if_match):
    ...
    if not force:
        if nsg_ids or security_attributes or rest or database_console or data_storage or ipv6_address_ipv6_subnet_cidr_pair_details or backup_policy or maintenance or freeform_tags or defined_tags or deletion_policy or secure_connections or encrypt_data or customer_contacts or read_endpoint or telemetry_configuration:
            if not click.confirm("WARNING: Updates to nsg-ids and security-attributes and rest and database-console and data-storage and ipv6-address-ipv6-subnet-cidr-pair-details and backup-policy and maintenance and freeform-tags and defined-tags and deletion-policy and secure-connections and encrypt-data and customer-contacts and read-endpoint and telemetry-configuration will replace any existing values. Are you sure you want to continue?"):
                ctx.abort()
