...
@cli_util.wrap_exceptions
def copy_backup(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, compartment_id, source_backup_id, source_region, description, display_name, if_match):
