...
@cli_util.option('--replica-overrides', type=custom_types.CLI_COMPLEX_TYPE, help=u"""""" + custom_types.cli_complex_type.COMPLEX_TYPE_HELP)
...
@json_skeleton_utils.get_cli_json_input_option({'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'replica-overrides': {'module': 'mysql', 'class': 'ReplicaOverrides'}})
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'replica-overrides': {'module': 'mysql', 'class': 'ReplicaOverrides'}}, output_type={'module': 'mysql', 'class': 'Replica'})
@cli_util.wrap_exceptions
def create_replica(ctx, from_json, wait_for_state, max_wait_seconds, wait_interval_seconds, db_system_id, display_name, description, freeform_tags, defined_tags, is_delete_protected, replica_overrides):
    ...
    if replica_overrides is not None:
        _details['replicaOverrides'] = cli_util.parse_json_parameter("replica_overrides", replica_overrides)
...
@cli_util.wrap_exceptions
def list_replicas(ctx, from_json, all_pages, page_size, compartment_id, limit, page, display_name, db_system_id, lifecycle_state, replica_id, configuration_id, is_up_to_date, sort_by, sort_order):
...
@cli_util.help_option
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'freeform-tags': {'module': 'mysql', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'mysql', 'class': 'dict(str, dict(str, object))'}, 'replica-overrides': {'module': 'mysql', 'class': 'ReplicaOverrides'}})
@cli_util.wrap_exceptions
def update_replica(ctx, from_json, force, wait_for_state, max_wait_seconds, wait_interval_seconds, replica_id, display_name, description, freeform_tags, defined_tags, is_delete_protected, replica_overrides, if_match):
    ...
    if not force:
        if freeform_tags or defined_tags or replica_overrides:
            if not click.confirm("WARNING: Updates to freeform-tags and defined-tags and replica-overrides will replace any existing values. Are you sure you want to continue?"):
                ctx.abort()
