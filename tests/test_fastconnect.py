...
def cross_connect_group(runner, config_file, config_profile):
    ...
    ccg_id = None
    with test_config_container.create_vcr().use_cassette('test_fastconnect_fixture_crossconnectgroup.yml'):
    ...
    with test_config_container.create_vcr().use_cassette('test_fastconnect_fixture_crossconnectgroup_delete.yml'):
        if ccg_id:
...
def cross_connect(runner, config_file, config_profile, cross_connect_group):
    ...
    cc_id = None
    with test_config_container.create_vcr().use_cassette('test_fastconnect_fixture_crossconnect.yml'):
    ...
    with test_config_container.create_vcr().use_cassette('test_fastconnect_fixture_crossconnect_delete.yml'):
        if cc_id:
...
def test_virtual_circuit_crud_operations(runner, config_file, config_profile, cross_connect_group, cross_connect):
    ...
    vc_id = None
    with test_config_container.create_vcr().use_cassette('test_fastconnect_fixture_virtualcircuit.yml'):
    ...
    with test_config_container.create_vcr().use_cassette('test_fastconnect_fixture_virtualcircuit_delete.yml'):
        if vc_id:
