...
def test_create_kubeconfig_1(runner, config_file, config_profile, oce_cluster):
    with test_config_container.create_vcr().use_cassette('test_oce_create_kubeconfig_test1.yml'):
...
def test_create_kubeconfig_2(runner, config_file, config_profile, oce_cluster):
    with test_config_container.create_vcr().use_cassette('test_oce_create_kubeconfig_test2.yml'):
...
def test_create_kubeconfig_3(runner, config_file, config_profile, oce_cluster):
    with test_config_container.create_vcr().use_cassette('test_oce_create_kubeconfig_test3.yml'):
        config_file_path = os.path.expandvars(os.path.expanduser(USER_KUBECONFIG_LOCATION))
...
def test_create_kubeconfig_4(runner, config_file, config_profile, oce_cluster):
    with test_config_container.create_vcr().use_cassette('test_oce_create_kubeconfig_test4.yml'):
...
def test_create_kubeconfig_5(runner, config_file, config_profile, oce_cluster):
    with test_config_container.create_vcr().use_cassette('test_oce_create_kubeconfig_test5.yml'):
...
def test_create_kubeconfig_6(runner, config_file, config_profile, oce_cluster):
    with test_config_container.create_vcr().use_cassette('test_oce_create_kubeconfig_test6.yml'):
        config_file_path = os.path.expandvars(os.path.expanduser(USER_KUBECONFIG_LOCATION))
        # There should be no file at user provided location for this test.
        if os.path.isfile(config_file_path):
            os.remove(config_file_path)
