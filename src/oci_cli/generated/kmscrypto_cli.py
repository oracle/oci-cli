...
@cli.command(cli_util.override('kms_crypto_root_group.command_name', 'kms_crypto'), cls=CommandGroupWithAlias, help=cli_util.override('kms_crypto_root_group.help', """API for managing and performing operations with keys and vaults."""), short_help=cli_util.override('kms_crypto_root_group.short_help', """Key Management Service API"""))
