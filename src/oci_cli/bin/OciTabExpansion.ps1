...
$ociSubcommands = @{
    ...
    'audit event' = 'list'
    'bv' = 'backup boot-volume boot-volume-backup volume volume-backup-policy volume-backup-policy-assignment volume-group volume-group-backup'
...
$ociCommandsToLongParams = @{
    ...
    'lb load-balancer create' = 'backend-sets certificates compartment-id display-name from-json help hostnames is-private listeners max-wait-seconds path-route-sets shape-name subnet-ids wait-for-state wait-interval-seconds'
    ...
    'network local-peering-gateway create' = 'compartment-id defined-tags display-name freeform-tags from-json help max-wait-seconds vcn-id wait-for-state wait-interval-seconds'
    ...
    'network local-peering-gateway update' = 'defined-tags display-name force freeform-tags from-json help if-match local-peering-gateway-id max-wait-seconds wait-for-state wait-interval-seconds'
    ...
    'network service-gateway attach' = 'from-json help if-match service-gateway-id service-id'
    ...
    'network service-gateway detach' = 'from-json help if-match service-gateway-id service-id'
