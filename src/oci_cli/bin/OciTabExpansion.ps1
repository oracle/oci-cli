...
$ociSubcommands = @{
    ...
    'audit event' = 'list'
    'bv' = 'backup boot-volume volume volume-backup-policy volume-backup-policy-assignment volume-group volume-group-backup'
