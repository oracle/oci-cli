$ociTopLevelCommands = @(
    'audit', 'bv', 'compute', 'db', 'iam', 'lb', 'network', 'os', 'setup'
)
...
$ociSubcommands = @{
    ...
    'network' = 'cpe dhcp-options drg drg-attachment internet-gateway ip-sec-connection local-peering-gateway private-ip route-table security-list subnet vcn vnic'
...
$ociCommandsToLongParams = @{
    ...
    'bv backup create' = 'display-name from-json help max-wait-seconds volume-id wait-for-state wait-interval-seconds'
    ...
    'bv backup update' = 'display-name from-json help if-match max-wait-seconds volume-backup-id wait-for-state wait-interval-seconds'
    ...
    'bv volume create' = 'availability-domain compartment-id display-name from-json help max-wait-seconds size-in-gbs size-in-mbs source-volume-id volume-backup-id wait-for-state wait-interval-seconds'
    ...
    'bv volume update' = 'display-name from-json help if-match max-wait-seconds volume-id wait-for-state wait-interval-seconds'
    'compute console-history capture' = 'display-name from-json help instance-id max-wait-seconds wait-for-state wait-interval-seconds'
    ...
    'compute console-history update' = 'display-name from-json help if-match instance-console-history-id max-wait-seconds wait-for-state wait-interval-seconds'
    'compute image create' = 'compartment-id display-name from-json help image-source-details instance-id max-wait-seconds wait-for-state wait-interval-seconds'
    ...
    'compute image import from-object' = 'bucket-name compartment-id display-name from-json help name namespace'
    'compute image import from-object-uri' = 'compartment-id display-name from-json help uri'
    'compute image list' = 'all compartment-id display-name from-json help lifecycle-state limit operating-system operating-system-version page page-size sort-by sort-order'
    'compute image update' = 'display-name from-json help if-match image-id max-wait-seconds wait-for-state wait-interval-seconds'
    ...
    'compute instance detach-vnic' = 'compartment-id force from-json help vnic-id'
    'compute instance get' = 'from-json help instance-id'
    'compute instance get-windows-initial-creds' = 'from-json help instance-id'
    'compute instance launch' = 'assign-public-ip availability-domain compartment-id display-name extended-metadata from-json help hostname-label image-id ipxe-script-file max-wait-seconds metadata private-ip shape skip-source-dest-check source-details ssh-authorized-keys-file subnet-id user-data-file vnic-display-name wait-for-state wait-interval-seconds'
    ...
    'compute instance update' = 'display-name from-json help if-match instance-id max-wait-seconds wait-for-state wait-interval-seconds'
    'compute instance-console-connection create' = 'from-json help instance-id max-wait-seconds ssh-public-key-file wait-for-state wait-interval-seconds'
    ...
    'compute volume-attachment attach' = 'display-name from-json help instance-id max-wait-seconds type volume-id wait-for-state wait-interval-seconds'
    'compute volume-attachment detach' = 'force from-json help if-match volume-attachment-id'
    ...
    'db data-guard-association create from-existing-db-system' = 'creation-type database-admin-password database-id from-json help max-wait-seconds peer-db-system-id protection-mode transport-type wait-for-state wait-interval-seconds'
    ...
    'iam compartment create' = 'compartment-id description from-json help max-wait-seconds name wait-for-state wait-interval-seconds'
    ...
    'iam compartment update' = 'compartment-id description from-json help if-match max-wait-seconds name wait-for-state wait-interval-seconds'
    ...
    'iam group create' = 'compartment-id description from-json help max-wait-seconds name wait-for-state wait-interval-seconds'
    ...
    'iam group update' = 'description from-json group-id help if-match max-wait-seconds wait-for-state wait-interval-seconds'
    'iam policy create' = 'compartment-id description from-json help max-wait-seconds name statements version-date wait-for-state wait-interval-seconds'
    ...
    'iam policy update' = 'description force from-json help if-match policy-id statements version-date'
    ...
    'iam user create' = 'compartment-id description from-json help max-wait-seconds name wait-for-state wait-interval-seconds'
    ...
    'iam user update' = 'description from-json help if-match max-wait-seconds user-id wait-for-state wait-interval-seconds'
    'iam user update-user-state' = 'blocked from-json help if-match user-id'
    'lb backend create' = 'backend-set-name backup drain from-json help ip-address load-balancer-id offline port weight'
    'lb backend delete' = 'backend-name backend-set-name force from-json help load-balancer-id'
    ...
    'lb backend update' = 'backend-name backend-set-name backup drain from-json help load-balancer-id offline weight'
    'lb backend-health get' = 'backend-name backend-set-name from-json help load-balancer-id'
    'lb backend-set create' = 'backends from-json health-checker-interval-in-ms health-checker-port health-checker-protocol health-checker-response-body-regex health-checker-retries health-checker-return-code health-checker-timeout-in-ms health-checker-url-path help load-balancer-id name policy session-persistence-cookie-name session-persistence-disable-fallback ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate'
    'lb backend-set delete' = 'backend-set-name force from-json help load-balancer-id'
    'lb backend-set get' = 'backend-set-name from-json help load-balancer-id'
    'lb backend-set list' = 'from-json help load-balancer-id'
    'lb backend-set update' = 'backend-set-name backends force from-json health-checker-interval-in-ms health-checker-port health-checker-protocol health-checker-response-body-regex health-checker-retries health-checker-return-code health-checker-timeout-in-ms health-checker-url-path help load-balancer-id policy session-persistence-cookie-name session-persistence-disable-fallback ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate'
    'lb backend-set-health get' = 'backend-set-name from-json help load-balancer-id'
    'lb certificate create' = 'ca-certificate-file certificate-name from-json help load-balancer-id passphrase private-key-file public-certificate-file'
    'lb certificate delete' = 'certificate-name force from-json help load-balancer-id'
    ...
    'lb health-checker update' = 'backend-set-name from-json help interval-in-millis load-balancer-id port protocol response-body-regex retries return-code timeout-in-millis url-path'
    'lb listener create' = 'default-backend-set-name from-json help load-balancer-id name port protocol ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate'
    'lb listener delete' = 'force from-json help listener-name load-balancer-id'
    'lb listener update' = 'default-backend-set-name force from-json help listener-name load-balancer-id port protocol ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate'
    'lb load-balancer create' = 'backend-sets certificates compartment-id display-name from-json help is-private listeners shape-name subnet-ids'
    ...
    'lb load-balancer update' = 'display-name from-json help load-balancer-id'
    ...
    'network dhcp-options create' = 'compartment-id display-name from-json help max-wait-seconds options vcn-id wait-for-state wait-interval-seconds'
    ...
    'network dhcp-options update' = 'dhcp-id display-name force from-json help if-match max-wait-seconds options wait-for-state wait-interval-seconds'
    ...
    'network private-ip update' = 'display-name from-json help hostname-label if-match private-ip-id'
    'network route-table create' = 'compartment-id display-name from-json help max-wait-seconds route-rules vcn-id wait-for-state wait-interval-seconds'
    ...
    'network route-table update' = 'display-name force from-json help if-match max-wait-seconds route-rules rt-id wait-for-state wait-interval-seconds'
    'network security-list create' = 'compartment-id display-name egress-security-rules from-json help ingress-security-rules max-wait-seconds vcn-id wait-for-state wait-interval-seconds'
    ...
    'network security-list update' = 'display-name egress-security-rules force from-json help if-match ingress-security-rules max-wait-seconds security-list-id wait-for-state wait-interval-seconds'
    'network subnet create' = 'availability-domain cidr-block compartment-id dhcp-options-id display-name dns-label from-json help max-wait-seconds prohibit-public-ip-on-vnic route-table-id security-list-ids vcn-id wait-for-state wait-interval-seconds'
    ...
    'network subnet update' = 'display-name from-json help if-match max-wait-seconds subnet-id wait-for-state wait-interval-seconds'
    'network vcn create' = 'cidr-block compartment-id display-name dns-label from-json help max-wait-seconds wait-for-state wait-interval-seconds'
    ...
    'network vcn update' = 'display-name from-json help if-match max-wait-seconds vcn-id wait-for-state wait-interval-seconds'
    'network vnic assign-private-ip' = 'display-name from-json help hostname-label ip-address unassign-if-already-assigned vnic-id'
    ...
    'os bucket update' = 'from-json help if-match metadata name namespace public-access-type'
