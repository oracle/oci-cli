...
$ociSubcommands = @{
    ...
    'iam' = 'availability-domain compartment customer-secret-key dynamic-group group policy region region-subscription smtp-credential tag tag-namespace user'
    ...
    'lb' = 'backend backend-health backend-set backend-set-health certificate health-checker listener load-balancer load-balancer-health path-route-set policy protocol shape work-request'
    ...
    'network' = 'cpe dhcp-options drg drg-attachment internet-gateway ip-sec-connection local-peering-gateway private-ip public-ip remote-peering-connection route-table security-list subnet vcn vnic'
...
$ociCommandsToLongParams = @{
    ...
    'fs file-system create' = 'availability-domain compartment-id display-name from-json help max-wait-seconds wait-for-state wait-interval-seconds'
    ...
    'fs file-system update' = 'display-name file-system-id from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
    'fs mount-target create' = 'availability-domain compartment-id display-name from-json help hostname-label ip-address max-wait-seconds subnet-id wait-for-state wait-interval-seconds'
    ...
    'fs mount-target update' = 'display-name from-json help if-match max-wait-seconds mount-target-id wait-for-state wait-interval-seconds'
    'fs snapshot create' = 'file-system-id from-json help max-wait-seconds name wait-for-state wait-interval-seconds'
    ...
    'lb listener create' = 'connection-configuration-idle-timeout default-backend-set-name from-json help load-balancer-id max-wait-seconds name path-route-set-name port protocol ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate wait-for-state wait-interval-seconds'
    ...
    'lb listener update' = 'connection-configuration-idle-timeout default-backend-set-name force from-json help listener-name load-balancer-id max-wait-seconds path-route-set-name port protocol ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate wait-for-state wait-interval-seconds'
    'lb load-balancer create' = 'backend-sets certificates compartment-id display-name from-json help is-private listeners max-wait-seconds path-route-sets shape-name subnet-ids wait-for-state wait-interval-seconds'
    ...
    'os bucket create' = 'compartment-id defined-tags freeform-tags from-json help metadata name namespace namespace-name public-access-type storage-tier'
    ...
    'os bucket update' = 'bucket-name compartment-id defined-tags freeform-tags from-json help if-match metadata name namespace namespace-name public-access-type'
