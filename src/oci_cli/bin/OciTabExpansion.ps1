...
$ociCommandsToLongParams = @{
    ...
    'bv backup create' = 'defined-tags display-name freeform-tags from-json help max-wait-seconds volume-id wait-for-state wait-interval-seconds'
    ...
    'bv volume create' = 'availability-domain compartment-id defined-tags display-name freeform-tags from-json help max-wait-seconds size-in-gbs size-in-mbs source-volume-id volume-backup-id wait-for-state wait-interval-seconds'
