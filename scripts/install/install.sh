...
INSTALL_SCRIPT_URL="https://raw.githubusercontent.com/oracle/oci-cli/v2.9.2/scripts/install/install.py"
FALLBACK_INSTALL_SCRIPT_URL="https://raw.githubusercontent.com/oracle/oci-cli/v2.6.12/scripts/install/install.py"
_TTY=/dev/tty
